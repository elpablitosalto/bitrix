...
if ($arParams['OG']['SET'] == 'Y') {
    ...
    if (!empty($arResult['DETAIL_PICTURE'])) {
        $arResult['OG']['OG_IMAGE'] = $arResult['DETAIL_PICTURE']['SRC'];
    }
}
// <-- Разметка OG
?>
...
<?
$this->__component->SetResultCacheKeys(array("ID", "NAME", "arFilterResult", "DISPLAY_PROPERTIES", "DETAIL_PAGE_URL", "OG"));
?>