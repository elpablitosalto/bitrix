...
<footer class="dp-footer">
	<div class="container">
		<div class="row">
			<div class="col dp-footer-col-logo"><a class="dp-footer-logo" href="/"><img class="dp-footer-logo__img" src="<?= SITE_TEMPLATE_PATH ?>/img/design/logo.svg" alt="Герофарм" width="185" height="80"></a></div>
...
<div class="dp-modals">
	...
	<? $APPLICATION->IncludeComponent(
		...
		array(
			...
			"MINDBOX" => "mindboxQuiz",
			"FIELDS" => [
				"PROPERTY_WORK" => ["NOT_EMPTY", "LIST_MULTIPLE"],
				"PROPERTY_STR1" => ["CLEAR", "NUMBER"],
				"PROPERTY_STR2" => ["CLEAR", "NUMBER"],
				"PROPERTY_REASON" => ["HL_MULTIPLE"],
				"PROPERTY_REASON2" => ["NOT_EMPTY", "LIST_MULTIPLE"],
				"PROPERTY_REASON_RESULT" => ["NOT_EMPTY", "LIST_MULTIPLE"],
	...
	<? } elseif (!isset($_COOKIE["cookie_agree"])){ ?>
		<div class="dp-modal dp-modal-required dp-modal-cookies dp-modal_active" id="modal-cookies" style="display: block;">
			<div class="dp-modal__overlay"></div>
			<div class="dp-modal__dialog">
				<div class="dp-modal__body">
					<p>Цифровая Академия работает с файлами cookie, чтобы совершенствовать сервис. Используя сайт, вы соглашаетесь с&nbsp;<a href="#" target="_blank">этим</a>.</p>
				</div>
				<div class="dp-modal__footer">
					<button onclick="cookie_agree()" class="dp-btn dp-btn_orange dp-modal-required__confirm-btn" type="button">Принять</button>
				</div>
			</div>
		</div>
		<script>
				...
				<div class="dp-modal__body">
					...
					<? $APPLICATION->IncludeComponent(
						...
						array(
							"USER_PROPERTY_NAME" => "",
							"SEF_MODE" => "N",
							"SHOW_FIELDS" => array("NAME", "LAST_NAME", "PERSONAL_PHONE", "UF_SPECIALITY", "UF_AGREEMENT"),
							"REQUIRED_FIELDS" => array("NAME", "LAST_NAME", "PERSONAL_PHONE", "UF_SPECIALITY", "UF_AGREEMENT"),
							"AUTH" => "Y",
							"USE_BACKURL" => "Y",
							"SUCCESS_PAGE" => "",
							"SET_TITLE" => "N",
