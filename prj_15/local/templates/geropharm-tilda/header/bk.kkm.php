...
<link rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/css/tilda-blocks-page27700283.min.css" type="text/css" media="all" onerror="this.loaderr='y';"/>
...
<link rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/css/tilda-menusub-1.0.min.css" type="text/css" media="print" onload="this.media='all';" onerror="this.loaderr='y';"/>
<noscript>
...
<script type="text/javascript">(function (d) {
	...
	function indexis_mb_event(id) {
		mindboxSubscriptionFormCourse({'name':'Название курса', 'specialty': 'специальность', 'email': 'email' });
		// document.querySelector('#form' + id).addEventListener('tildaform:aftersuccess', function() {
		// 	mindboxSubscriptionLifeCode('Email');
		// })
	}
...
<script src="<?=SITE_TEMPLATE_PATH?>/js/tilda-blocks-page27700283.min.js?t=1690368943" charset="utf-8" async onerror="this.loaderr='y';"></script>
...
<script src="<?=SITE_TEMPLATE_PATH?>/js/tilda-cards-1.0.min.js" charset="utf-8" async onerror="this.loaderr='y';"></script>
<!--	<script src="<?=SITE_TEMPLATE_PATH?>/js/tilda-forms-1.0.min.js" charset="utf-8" async onerror="this.loaderr='y';"></script>-->
<script src="<?=SITE_TEMPLATE_PATH?>/js/tilda-t635-typed-1.0.min.js" charset="utf-8" async onerror="this.loaderr='y';"></script>
