document.addEventListener("DOMContentLoaded", function() {
    var script = document.getElementById('225526ebd08a278a8ae24ab91b29133021e3c931');

	var par = script.parentNode;
	script.parentNode.style.overflow = 'hidden';

	var iframe = document.createElement('iframe');
	iframe.src = 'widgets/widget-2.html';
	iframe.style.width = '100%';
	iframe.style.height = '0px';
	iframe.style.border = 'none';
	iframe.style.overflow = 'hidden';
	iframe.setAttribute('allowfullscreen', 'allowfullscreen');
    iframe.className = '960';
	iframe.id = '83c041be803f1481c22c16ffc3e5a36af14bef18' + '_' + iframe.className;
	...
	var gcEmbedOnMessage = function(e) {
		...
		if (e.data.uniqName == '225526ebd08a278a8ae24ab91b29133021e3c931') {
			if (e.data.height) {
