            ...
            <div class="bx-auth">
                    ...
                    <form method="post" action="<?= $arResult["AUTH_URL"] ?>" name="bform">
                        ...
                        <table class="data-table bx-changepass-table">
                            ...
                            <? if ($arResult["PHONE_REGISTRATION"]): ?>
                                ...
                                <tr>
                                    <td><span class="starrequired">*</span><? echo GetMessage("sys_auth_chpass_code") ?>
                                    </td>
                            ...
                            <? else: ?>
                                <tr>
                                    ...
                                    <td><input type="text" name="USER_LOGIN" maxlength="50"
                                               value="<?= $arResult["LAST_LOGIN"] ?>" class="bx-auth-input"/></td>
                                </tr>
                                <?
				...
				<span class="bx-auth-secure" title="<? echo GetMessage("AUTH_NONSECURE_NOTE") ?>">
					<div class="bx-auth-secure-icon bx-auth-secure-unlock"></div>
                            ...
                            <tr>
                                <td><span class="starrequired">*</span><?= GetMessage("AUTH_NEW_PASSWORD_CONFIRM") ?>
                                </td>
                            ...
                            <tr>
                                <td></td>
                                <td><br><input class="dp-btn dp-btn_m" type="submit" name="change_pwd" value="<?= GetMessage("AUTH_CHANGE") ?>"/>
                                </td>
                            </tr>
                            </tfoot>
                        </table>
