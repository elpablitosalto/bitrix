            ...
            <div class="row flex-lg-row-reverse">
                ...
                <div class="col-lg-6">
                    <div class="dp-courses-item__caption">
                        <div class="dp-courses-item__tags"><span class="dp-courses-item__tag dp-courses-item__category"><?=($arItem["IBLOCK_ID"] == indexis::getIblockId("courses", "content"))?"курс":"мастер-клас";?></span></div>
