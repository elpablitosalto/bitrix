...
<div class="dp-modal dp-get-course-modal" id="free-lesson-modal">
	...
	<div class="dp-modal__dialog">
		...
		<div class="dp-modal__header">
			<div class="dp-modal__title">Пробный урок курса «Эмоциональное выгорание. Основы баланса»</div>
		</div>
		<div class="dp-modal__body">
			<form class="dp-form dp-form-get-course" id="form-vigoranie-balance-free" method="post" action="#">
