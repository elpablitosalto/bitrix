...
<div class="dp-modal dp-get-course-modal" id="tariff-base-pay-modal">
	...
	<div class="dp-modal__dialog">
		...
		<div class="dp-modal__header">
			...
			<p class="dp-modal__tariff">Тариф «Базовый»</p>
			<p class="dp-modal__price">3 990 ₽</p>
		</div>
		<div class="dp-modal__body">
			<form class="dp-form dp-form-get-course" id="form-tariff-base-pay" method="post" action="#">
				<div class="dp-form__body">
					...
					<input type="hidden" name="price" value="3 990">
					<div class="dp-field">
				...
				<div class="dp-form__footer">
					...
					<div class="dp-field dp-field_agreement">
						<input id="ftbp-agreement" type="checkbox" name="ftbp-agreement">
						<label for="ftbp-agreement"></label><span>Я согласен на&nbsp;обработку моих персональных данных в&nbsp;соответствии с&nbsp;<a href="#" target="_blank">Договором оферты</a> и&nbsp;<a href="/privacy/" target="_blank">Политикой Конфиденциальности</a></span>
					</div>
				</div>
			</form>
		</div>
