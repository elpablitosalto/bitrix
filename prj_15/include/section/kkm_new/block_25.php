...
<? $APPLICATION->IncludeComponent(
    ...
    array(
        "IBLOCK_ID" => Indexis::getIblockId("submit_application_kkm", "forms", "s1"),
        "IBLOCK_TYPE" => "forms",
        "RETURN_FIELDS" => "Y",
        "MINDBOX_TYPE" => "JS",
        "FORM_ID" => "get_consultation_2",
        "MINDBOX" => "mindboxGetMaterialsKkm",
        "FIELDS" => [
        ...
        "SEND_MESSAGE" => "Y",
        "MESSAGE_TEMPLATE" => "SUBMIT_APPLICATION_KKM",
        'CHECK_PHONE' => 'N',
        'MODAL_ID' => 'submit-application',
        'PHONE_MASK_INPUT_CLASS' => 'js_phone_country_kkm_2',
    )
); ?>
