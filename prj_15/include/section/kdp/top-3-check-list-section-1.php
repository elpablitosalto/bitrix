...
<div id="top-3-check-list-section-1" class="dp-top-3-check-list-section dp-top-3-check-list-section-1">
			...
			<div class="row">
				<div class="col-md-7">
					<div class="dp-top-3-check-list__wrapper">
						...
						<h2 class="dp-top-3-check-list__desc">и сможете уже применять<br>советы по общению с трудным пациентом<br>на практике</h2>
					</div>
				</div>
				<div class="col-md-5">
					<form class="dp-form dp-mc-reg-form" action="">
						<div class="dp-form__header">
							<p>Зарегистрируйтесь <br>на&nbsp;бесплатный мастер-класс <br>25.01.2024
							</p>
						</div>
						<div class="dp-form__body">
							<div class="row">
								<div class="col-12 col-time">
									...
									<div class="dp-field">
										<input id="mcrf-1-time-1" type="checkbox" name="mcrf-1-time-1">
										<label for="mcrf-1-time-1">15:00</label>
									</div>
									<div class="dp-field">
										<input id="mcrf-1-time-2" type="checkbox" name="mcrf-1-time-2">
										<label for="mcrf-1-time-2">19:00</label>
									</div>
								</div>
								<div class="col-12">
									<div class="dp-field">
						...
						<div class="dp-form__footer">
							<div class="dp-field dp-field_agreement">
								<input id="mcrf-1-agreement" type="checkbox" name="mcrf-1-agreement">
