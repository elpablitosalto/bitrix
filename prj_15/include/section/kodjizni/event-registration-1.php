...
<div class="dp-modal dp-get-course-modal" id="event-registration-1">
	...
	<div class="dp-modal__dialog">
		...
		<div class="dp-modal__header">
			<div class="dp-modal__title">Регистрация на&nbsp;мероприятие «Хроническое низкоуровневое воспаление – основной подводный камень в&nbsp;пептидной терапии»</div>
		</div>
		<div class="dp-modal__body">
			<form class="dp-form dp-form-get-course" id="form-event-registration-1" method="post" action="#">
				<div class="dp-form__body">
					<input type="hidden" name="event" value="Код жизни. Вебинар «Хроническое низкоуровневое воспаление – основной подводный камень в пептидной терапии»">
