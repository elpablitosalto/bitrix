...
<div class="dp-modal dp-get-course-modal" id="event-registration-modal-2">
	...
	<div class="dp-modal__dialog">
		...
		<div class="dp-modal__header">
			<div class="dp-modal__title">Регистрация на&nbsp;мероприятие «Нутритивные стратегии в&nbsp;сопровождении пептидной биорегуляции»</div>
		</div>
		<div class="dp-modal__body">
			<form class="dp-form dp-form-get-course" id="form-event-registration-2" method="post" action="#">
				<div class="dp-form__body">
					<input type="hidden" name="event" value="Код жизни. Вебинар «Нутритивные стратегии в сопровождении пептидной биорегуляции»">
