...
<div class="product-carousel section__product-carousel">
    <div class="product-carousel__container swiper js-product-carousel">
        <div class="product-carousel__wrapper swiper-wrapper">
            <?foreach($arResult['ITEMS'] as $k => $arItem):?>
                <li class="product-carousel__slide swiper-slide">
                    <!-- begin .product-snippet-->
                    <div class="product-snippet product-carousel__product">
                        <? if (!empty($arItem['PROPERTIES']['SECONDARY_IMAGE']['VALUE'])) : ?>
                            <?
                            $bgImage = CFile::ResizeImageGet($arItem['PROPERTIES']['SECONDARY_IMAGE']['VALUE'], array('width' => 1999, 'height' => 1008), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            $mobileImg = CFile::ResizeImageGet($arItem['PROPERTIES']['SECONDARY_IMAGE']['VALUE'], array('width' => 425, 'height' => 692), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            ?>
                        ...
                        <? endif; ?>
                        <div class="product-snippet__label"><?= $arItem["NAME"] ?></div>
                        <div class="product-snippet__title">
                            <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>" class="product-snippet__link">
                                <?= htmlspecialchars_decode($arItem["PREVIEW_TEXT"]) ?>
                            </a>
                        </div>
                        <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>" class="product-snippet__illustration">
                            <?
                            $arImage = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array('width' => 692, 'height' => 692), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            $mobileImg = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array('width' => 425, 'height' => 692), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            ?>
                            <picture class="product-snippet__picture">
                                <source srcset="<?= $mobileImg['src'] ?>" type="image/jpeg" media="(max-width: 425px)" />
                                <img src="<?= $arImage["src"] ?>" alt="<?= $arItem["NAME"] ?>" class="product-snippet__image" title="" />
                            </picture>
                        </a>
                                        ...
                                        <? foreach ($arItem["PRODUCT_VARIANTS"]["PROPERTY_VALUES"] as $propValue) : ?>
                                            <li class="choice-group__item">
                                                <label class="choice-group__label">
                                                    ...
                                                    <input class="choice-group__input" type="radio" name="product-filter-<?= $arItem["ID"] ?>-<?= $arItem["PRODUCT_VARIANTS"]["PROPERTY_CODE"] ?>" />
        ...
        <div class="product-carousel__navigation">
            <div class="page__container">
                <div class="product-carousel__arrows">
                    <!-- begin .carousel-nav-->
                    <div
                        class="carousel-nav carousel-nav_position_sides carousel-nav_arrow-style_solid carousel-nav_arrow-size_l js-carousel-nav"
                            ...
                            >
                                ...
                                >
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M12.0466 21.4207C12.1921 21.2756 12.3075 21.1032 12.3863 20.9133C12.4651 20.7235 12.5056 20.52 12.5056 20.3145C12.5056 20.1089 12.4651 19.9054 12.3863 19.7156C12.3075 19.5258 12.1921 19.3534 12.0466 19.2082L3.7747 10.9395L12.0466 2.67072C12.34 2.37732 12.5048 1.97939 12.5048 1.56447C12.5048 1.14954 12.34 0.751614 12.0466 0.458218C11.7532 0.164822 11.3552 -3.86498e-06 10.9403 -3.88312e-06C10.5254 -3.90126e-06 10.1275 0.164822 9.83407 0.458218L0.459073 9.83322C0.313563 9.97836 0.198118 10.1508 0.119347 10.3406C0.0405774 10.5304 3.10048e-05 10.7339 3.09958e-05 10.9395C3.09868e-05 11.145 0.0405774 11.3485 0.119347 11.5383C0.198118 11.7282 0.313563 11.9006 0.459073 12.0457L9.83407 21.4207C9.97922 21.5662 10.1516 21.6817 10.3415 21.7604C10.5313 21.8392 10.7348 21.8798 10.9403 21.8798C11.1458 21.8798 11.3493 21.8392 11.5392 21.7604C11.729 21.6817 11.9014 21.5662 12.0466 21.4207Z"
                                    />
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M21.8777 10.9395C21.8777 10.5251 21.7131 10.1276 21.42 9.8346C21.127 9.54157 20.7296 9.37695 20.3152 9.37695L4.69019 9.37695C4.27579 9.37695 3.87836 9.54157 3.58533 9.8346C3.29231 10.1276 3.12769 10.5251 3.12769 10.9395C3.12769 11.3539 3.29231 11.7513 3.58533 12.0443C3.87836 12.3373 4.27579 12.502 4.69019 12.502L20.3152 12.502C20.7296 12.502 21.127 12.3373 21.42 12.0443C21.7131 11.7513 21.8777 11.3539 21.8777 10.9395Z"
                                    />
                                </svg>
                            </button>
                        </div>
