...
?>
<form id="events-filter-form" name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="/local/ajax/downloads/filter.php" method="get" class="smart-filter-form">
	<div class="catalog-filter">
						...
						<div class="catalog-filter__item-dropdown--wrapper">
							<?foreach($arItem["VALUES"] as $val => $ar):?>
								...
								<div class="catalog-filter__item--checkbox">
									...
									/>
									<label class="catalog-filter__item--checkbox-value" for="<?=$ar["CONTROL_ID"] ?>"><?=$label;?></label>
								</div>
							<?endforeach;?>
						</div>
					</div>
		...
		<?endforeach;?>
		<a href="#" class="button" data-filter-button>Применить</a>
		<a href="#" class="button _empty" data-refresh-button>Сбросить</a>
	</div>
</form>