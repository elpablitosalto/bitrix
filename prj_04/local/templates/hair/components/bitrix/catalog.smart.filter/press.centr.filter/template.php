...
?>
<form id="events-filter-form" name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="/local/ajax/press.centr/filter.php" method="get" class="smart-filter-form">
	<div class="catalog-filter">
		...
		<a href="#" class="button _empty">Сбросить</a>
	</div>
</form>