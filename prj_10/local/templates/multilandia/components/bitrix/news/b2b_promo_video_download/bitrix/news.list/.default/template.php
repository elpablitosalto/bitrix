        ...
        ?>
            <div class="col-6 col-md-3" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                <div class="anim-item anim-item_article">
                    <a class="anim-item__link" data-fancybox="cartoon-series" href="<?= $arItem['DISPLAY_PROPERTIES']['VIDEO']['FILE_VALUE']['SRC']; ?>">
                ...
                <br />
                <center>
                    <a download class="ml-btn ml-btn_round <?/*?>ml-header-auth-btn<?*/ ?>" href="<?= $arItem['DISPLAY_PROPERTIES']['VIDEO']['FILE_VALUE']['SRC']; ?>">
                        Скачать
                    </a>
                </center>
            </div>
