...
<div class="ml-page-content ml-cartoon-detail ml-news-detail">
    ...
    <? if (!empty($arResult['DISPLAY_PROPERTIES']['ARCHIVE']['FILE_VALUE']['SRC'])) { ?>
        <div class="ml-news-detail__content">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <br />
                    <center>
                        <a download class="ml-btn ml-btn_round" href="<?= $arResult['DISPLAY_PROPERTIES']['ARCHIVE']['FILE_VALUE']['SRC'] ?>">
                            Скачать архив
                        </a>
                    </center>
                    <?*/?>
                    ...
                    <br />
                    <a download href="<?= $arResult['DISPLAY_PROPERTIES']['ARCHIVE']['FILE_VALUE']['SRC'] ?>">Скачать архив</a>
                </div>
            </div>
        </div>
    <? } ?>
