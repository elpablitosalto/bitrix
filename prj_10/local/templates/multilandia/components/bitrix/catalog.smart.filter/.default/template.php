...
<div class="filter">
	<div class="filter-header">
		<button class="filter-close">
			<svg class="icon icon-close-simple ">
				<use xlink:href="#close-simple"></use>
			</svg>
		</button>
	</div>
    <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="filter-form">

        <?if (count($arResult['TAGS']) > 0):?>
            <div class="filter-section filter-section-checked filter-section-checked_active">
                <p class="filter-section__title">Вы выбрали</p>
                <ul class="filter-checked-list">
                    <?foreach($arResult['TAGS'] as $arTag):?>
                        <li class="filter-checked-item">
                            <span><?=$arTag['VALUE']?></span>
                            <button type="button" class="filter-checked-item__clear" data-for="<?=$arTag['CONTROL_NAME']?>">
                ...
                <label class="filter-clear-btn" type="button" for="del_filter">Сбросить</label>
            </div>
        <?endif;?>
        ...
        foreach($arResult["ITEMS"] as $key=>$arItem)
        {
            ...
            if (
                ...
                continue;
            ?>
            <div class="filter-section bx-filter-parameters-box">
                <span class="bx-filter-container-modef"></span>
                <p class="filter-section__title"><?=$arItem["NAME"]?></p>
                            ...
                            <ul class="filter-list">
                                <?foreach($arItem["VALUES"] as $val => $ar):?>
                                    <li class="filter-item">
                                        ...
                                        />
                                        <label class="filter-item__label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>"><?=$ar["VALUE"];?></label>
                                    </li>
                                <?endforeach;?>
                            </ul>
                    <?
	...
	<div class="filter-footer">
		<button class="ml-btn ml-btn_round filter-form__submit" type="button" onclick="$('#set_filter').click();">Применить фильтр</button>
	</div>
</div>
