    ...
    <section class="ml-section ml-section_bg">
        <div class="container">
            <div class="ml-section-header">
                <h2 class="ml-section-title">Анонсы</h2>
                <a class="ml-btn ml-btn_round ml-btn_<?=$mlTheme?> ml-section-btn" href="/movies/">Все анонсы</a>
            </div>
                            ...
                            <div class="ml-slider__wrapper">
                                <? foreach($arResult['ITEMS'] as $arItem):
                                    ...
                                    <div class="ml-slider__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                                        <div class="anim-item anim-item_dark">
                                            <a class="anim-item__link" href="<?=$arItem['DETAIL_PAGE_URL']?>">
                                                <div class="anim-item__img">
                                                    <img class="lazyload"
                                                         ...
                                                         alt=""/>
                                                    <span class="age-limit-label age-limit-label_light">0+</span>
