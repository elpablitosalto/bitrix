...
$componentElementParams = array(
    ...
    // Мои параметры -->
    'SHOW_CLOSE_NEWS' => $arParams['SHOW_CLOSE_NEWS'],
    // <-- Мои параметры
);
...
<div class="ml-page-content ml-cartoon-detail ml-news-detail">
    ...
    <? $APPLICATION->IncludeComponent(
        ...
        [
            ...
            "CODE_BANNERS" => "news",
            "ADDITIONAL_CLASS" => "",
            "PATH" => SITE_DIR . "include/news/right_banners.php"
        ]
    ); ?>

    <?
    // Показывать закрытые новости -->
    $showCloseNews = 'N';
    $USER_ID = $USER->GetID();
    if (!empty($USER_ID)) {
    ...
    if ($showCloseNews != 'Y') {
        $GLOBALS['arrFilterNewsOther']['PROPERTY_CLOSE_SECTION'] = false;
    }
    // <-- Показывать закрытые новости
    ?>
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "FILTER_NAME" => "arrFilterNewsOther",
...
$APPLICATION->IncludeFile(
    SITE_DIR . 'include/main_page/contests_children.php',
    [],
    ['SHOW_BORDER' => false]
);
// End Все конкурсы
...
// Расписание
$APPLICATION->IncludeFile(
    SITE_DIR . 'include/main_page/timetable.php',
    ['MOVIE_ID' => $elementId],
    ['SHOW_BORDER' => false]
);
// End Расписание
...
// Комментарии
$APPLICATION->IncludeFile(
    SITE_DIR . 'include/main_page/review-slider.php',
    ['MOVIE_ID' => $elementId, 'USER_ID' => $USER->GetID()],
    ['SHOW_BORDER' => false]
);
// End Комментарии
...
$APPLICATION->IncludeFile(
    SITE_DIR . 'include/main_page/recommendations.php',
    [],
    ['SHOW_BORDER' => false]
);
