...
?>
<div class="ml-page-content ml-cartoon-detail">
    <?php
    $elementId = $APPLICATION->IncludeComponent(
        'bitrix:catalog.element', 'movie',
...
<?
/* Все конкурсы */
$APPLICATION->IncludeFile(SITE_DIR.'include/main_page/contests_children.php',
    [], ['SHOW_BORDER' => false]
);
/* End Все конкурсы */
...
/* Расписание */
$APPLICATION->IncludeFile(SITE_DIR.'include/main_page/timetable.php',
    ['MOVIE_ID' => $elementId], ['SHOW_BORDER' => false]
);
/* End Расписание */

/* Комментарии */
$APPLICATION->IncludeFile(SITE_DIR.'include/main_page/review-slider.php',
    ['MOVIE_ID' => $elementId, 'USER_ID' => $USER->GetID()], ['SHOW_BORDER' => false]
);
/* End Комментарии */

/* Рекомендуем мультфильмы */
$APPLICATION->IncludeFile(SITE_DIR.'include/main_page/recommendations.php',
    [], ['SHOW_BORDER' => false]
);
/* End Рекомендуем мультфильмы */

/* Баннеру внизу */
//$APPLICATION->IncludeFile(SITE_DIR.'include/main_page/bottom_banners.php',
//    [], ['SHOW_BORDER' => false]
//);
/* End Баннеру внизу */
