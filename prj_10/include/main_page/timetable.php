...
<section class="ml-section shedule-cartoon" style="margin-bottom:0;">
    <div class="container">
        ...
        <?
        global $arTimeTableByMovieFilter;
        $arTimeTableByMovieFilter = [
            'PROPERTY_MOVIE_ID' => $arParams['MOVIE_ID'],
            '>=PROPERTY_DATE_START' => FormatDate('Y-m-d H:i:s'),
            '<=PROPERTY_DATE_START' => FormatDate('Y-m-d H:i:s', time() + 280200),
        ];


        $paramsComponentCatalogSection = [
            "IBLOCK_ID" => Indexis::getIblockId('guide'),
            "IBLOCK_TYPE" => "guide",
            "FILTER_NAME" => "arTimeTableByMovieFilter",
            ...
            "DISPLAY_TOP_PAGER" => "N",
            "ELEMENT_SORT_FIELD" => "PROPERTY_DATE_START",
            ...
            "OFFERS_SORT_FIELD" => "PROPERTY_DATE_START",
            ...
            "PROPERTY_CODE" => array("MOVIE_ID", "DATE_START", "PREVIEW_PICTURE", "VOZRAST_VALUE"),
        ...
        $APPLICATION->IncludeComponent(
            "bitrix:catalog.section", "timetable_episode",
            $paramsComponentCatalogSection
        );
