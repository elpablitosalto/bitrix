...
//Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/libs/jquery.litesmileys/jquery.litesmileys.min.js");
?>
<?
...
if ($showCloseNews != 'Y') {
	$GLOBALS['arrFilterNews']['PROPERTY_CLOSE_SECTION'] = false;
}
// <-- Показывать закрытые новости
?>
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		'DETAIL_PROPERTY_CODE' => array('CLOSE_SECTION'),

		// Мои параметры -->
		'SHOW_CLOSE_NEWS' => $showCloseNews,
		// <-- Мои параметры
	),
	false
