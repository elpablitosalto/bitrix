...
$APPLICATION->AddChainItem("Политика в отношении обработки персональных данных", "");
?>
        ...
        <div class="col">
            ...
            <div class="descr">
                ...
                данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value"
                    data-scroll-to="#owner-name-field">Михайловым Иваном
                    Сергеевичем</span> (далее&nbsp;&mdash; Оператор).
            </div>
            <div class="ol">
                <div class="li">
                ...
                <div class="li">
                    ...
                    которую Оператор может получить о&nbsp;посетителях веб-сайта <span
                        ...
                        data-scroll-to="#owner-site-url-field">httpsː//thismywebsite·com</span>.
                </div>
            </div>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="ol">
                ...
                <div class="li">
                    2.10. Пользователь&nbsp;&mdash; любой посетитель веб-сайта <span
                        class="link mark owner-site-url-field"
                        data-scroll-to="#owner-site-url-field">httpsː//thismywebsite·com</span>.
                </div>
                <div class="li">
            ...
            <div class="ol">
                ...
                <div class="li">
                    ...
                    Оператору уведомление на&nbsp;адрес электронной почты Оператора <span
                        ...
                        data-scroll-to="#owner-email-field">privacy@thismywebsite·com</span>
            ...
            <div class="ol">
                ...
                <div class="li">
                    ...
                    в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value"
                        ...
                        data-scroll-to="#owner-privacy-url-field">httpsː//thismywebsite·com/privacy/</span>.
                </div>
            </div>
        </div>
    </div>
