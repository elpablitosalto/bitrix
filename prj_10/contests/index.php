...
$APPLICATION->SetTitle("Конкурсы");?><?$APPLICATION->IncludeComponent("bitrix:catalog", "contests", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"ELEMENT_SORT_FIELD" => "PROPERTY_DATE_START",	// По какому полю сортируем товары в разделе
		...
		"IBLOCK_TYPE" => "contests",	// Тип инфоблока
		...
		"SEF_FOLDER" => "/contests/",	// Каталог ЧПУ (относительно корня сайта)
		...
		// Параметры разработчика, не доступные для визуального редактирования -->
		"arDevParams" => array(
			"arModalsParams" => $GLOBALS["arSiteConfig"]["arModalsParams"], // параметры модальных окон, header.php
			"arContestParams" => $GLOBALS["arSiteConfig"]["arContestParams"],
		),
		// <--
	),
	false
