...
$APPLICATION->AddViewContent("main_class", "rs__news--detail");
?>
...
<section class="wrapper rs__page--head">
    <div class="container">
        <div class="rs__content">
            ...
            <?//в шаблоне детальной?>
            <?= $APPLICATION->ShowViewContent('news_title');?>
        </div>
    </div>
</section>
...
<div class="page-content news-detail-page">
    <? $ElementID = $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "PROG_ID" => $arParams["PROG_ID"],
            //"SEARCH_PAGE" => $arResult["FOLDER"] . $arResult["URL_TEMPLATES"]["search"],
            "SEARCH_PAGE" => $arResult["FOLDER"],
            "FILTER_NAME" => $arParams["~FILTER_NAME"],
            "FOLDER" => $arResult["FOLDER"],
            "TYPE_IBLOCK" => $arParams["TYPE_IBLOCK"],
            "COMPONENT" => $component,
        ),
        $component
    ); ?>
