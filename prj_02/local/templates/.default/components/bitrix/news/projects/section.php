            ...
            <div class="projects-controls">
                <div class="row">
                    <div class="col-sm-6 col-lg-8">
                        <button type="button" data-toggle-activity="#projects-filter"
                                class="btn projects-filter__toggler<? if ($arParams["SET_FILTER"] == "Y") echo " active"; ?>"><span
                                    class="txt-show">Фильтры</span><span class="txt-hide">Скрыть фильтры</span>
