...
?>
    <section id="projects-detail-how-we-help" class="projects-detail-how-we-help">
        <div class="container">
            <h3 class="section__title">Как мы помогаем</h3>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="section__nav">
                <div class="buttons-line"><a href="/contacts/" class="btn">Обратиться за помощью</a></div>
            </div>
        </div>
    </section>
<? } ?>
...
?>
    <section id="main-partners" class="main-partners">
        <div class="container">
            <h2 class="h3 section__title">Партнеры проекта</h2>
...
?>
    <? $APPLICATION->IncludeComponent(
        ...
        "reg_competition",
        array(
            "IBLOCK_ID" => Indexis::getIblockId("apps_comp_soc_proj", "requests", "s1"),
            "IBLOCK_TYPE" => "requests",
            "CREATE_LEAD" => "Подать заявку",
            "FIELDS" => [
                "NAME" => ["CLEAR", "NOT_EMPTY", "TEXT"],
                "PROPERTY_PROJECT_NAME" => ["CLEAR", "NOT_EMPTY", "TEXT"],
                "PROPERTY_EMAIL" => ["CLEAR", "NOT_EMPTY", "TEXT", "EMAIL"],
                "PROPERTY_PHONE" => ["CLEAR", "NOT_EMPTY", "PHONE"],
                "PROPERTY_APPL" => ["CLEAR", "NOT_EMPTY_FILE", "FILE"],
                "PROPERTY_APPL_CONFIRM" => ["CLEAR", "NOT_EMPTY_FILE", "FILE"],
                "PROPERTY_BUDGET" => ["CLEAR", "NOT_EMPTY_FILE", "FILE"],
                "PROPERTY_ART_ASSOC" => ["CLEAR", "NOT_EMPTY_FILE", "FILE"],
                //"PREVIEW_TEXT" => ["CLEAR", "NOT_EMPTY", "TEXT"],
                //"PROPERTY_TYPE" => ["NOT_EMPTY", "LIST"]
            ],
            "CHECK_CAPTCHA" => "Y",
            "PROJECT_NAME" => $arResult["NAME"],
            "SEND_MESSAGE" => "REG_COMPETITION",
            "HANDLERS" => [
