...
<section id="news-detail-hidden-nav" class="news-detail-hidden-nav">
    <div class="container">
        <div class="buttons-line"><a href="#news-help" data-scroll-to="#news-help" class="btn btn-help">Поддержать фонд</a><a href="#news-detail-share" data-scroll-to="#news-detail-share" class="btn btn-share">
...
if (!empty($arCurElement)) {
    ...
    if (strlen($arCurElement["PROPERTIES"]["AUDIENCE_TYPE"]["VALUE"]) > 0) {
