    ...
    <div class="container" id="<?= $this->GetEditAreaId($arResult['ID']); ?>">
                ...
                <div class="col-lg-5">
                    <div class="section__image">
                        <picture class="projects-detail-main__image">
                            <source media="(max-width: 767.98px)" srcset="<?=SITE_TEMPLATE_PATH?>/images/loader.svg"
                                    data-srcset="<?=$arResult["DETAIL_PICTURE"]["DETAIL_PICTURE_RESIZED_SMALL"]?>"/>
                            <source media="(min-width: 768px) and (max-width: 1279.98px)" srcset="<?=SITE_TEMPLATE_PATH?>/images/loader.svg"
                                    data-srcset="<?=$arResult["DETAIL_PICTURE"]["DETAIL_PICTURE_RESIZED_BIG"]?>"/>
                            <img class="lazyload" src="<?=SITE_TEMPLATE_PATH?>/images/loader.svg" data-src="<?=$arResult["DETAIL_PICTURE"]["DETAIL_PICTURE_RESIZED_MEDIUM"]?>" loading="lazy"
                                 alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" title="<?=$arResult["DETAIL_PICTURE"]["TITLE"]?>"/>
                        </picture>
                        <picture class="projects-detail-main__pattern"><img class="lazyload" src="<?=SITE_TEMPLATE_PATH?>/images/loader.svg"
                                                                            data-src="<?=SITE_TEMPLATE_PATH?>/images/projects-detail-first-image.png"
        ...
        <div id="projects-categories" class="nav-tabs-container projects-categories">
            <ul class="text-size-lg nav-tabs">
                ...
                <li><a href="#projects-detail-documents"
                       data-scroll-to="#projects-detail-documents">Документы</a></li>
                <?}?>
...
<section id="projects-detail-hidden-nav" class="projects-detail-hidden-nav">
    <div class="container">
        <div class="buttons-line"><a href="#projects-categories" data-scroll-to="#projects-categories"
                                     class="btn btn-white btn-page-nav xs-collapsed"><span>Разделы страницы</span>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                     class="icon icon-anchor">
                    <use xlink:href="#anchor"></use>
                </svg>
            </a><a href="#projects-detail-help" data-scroll-to="#projects-detail-help" class="btn btn-help">Поддержать
                программу</a><a href="#projects-detail-share" data-toggle-activity="#projects-detail-share"
                                class="btn btn-share">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <div id="projects-detail-share" class="projects-detail-share">
            <div data-curtain data-shape="round" data-color-scheme="blackwhite"
                 data-services="vkontakte,odnoklassniki,telegram,whatsapp" data-size="l"
                 class="ya-share2"></div>
        </div>
    </div>
</section>
...
<section id="projects-detail-about" class="projects-detail-about">
    <div class="container">
        ...
        <div id="projects-detail-desc" class="section__desc">
            ...
            <a href="#projects-detail-desc" data-toggle-activity="#projects-detail-desc"
               class="text-size-lg section__desc-toggler"><span class="txt-show">Читать описание</span><span
                        class="txt-hide">Скрыть описание</span></a>
            <?}?>
                ...
                <div id="projects-detail-documents" class="projects-detail-documents">
                    ...
                    <div class="items-list documents-list">
                        ...
                        <div class="list-item document-item">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 class="icon icon-pdf document-item__icon">
                            ...
                            <a href="<?=$arFile["SRC"]?>" class="btn btn-transparent document-item__link" download>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" class="icon icon-download">
                    ...
                    <div class="buttons-line section__nav"><a href="#projects-detail-documents"
                                                              data-toggle-activity="#projects-detail-documents"
                                                              class="btn btn-transparent projects-detail-documents-toggler"><span
                                    class="txt-show">Показать все</span><span
                                    class="txt-hide">Свернуть</span></a></div>
                    <?}?>
                </div>
            </div>
            <?}?>
