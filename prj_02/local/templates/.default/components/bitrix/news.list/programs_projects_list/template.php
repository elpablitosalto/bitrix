    ...
    <section id="projects-detail-projects" class="projects-detail-projects">
        <div class="container">
            ...
            <div class="section__nav">
                <div class="buttons-line"><a href="/projects/" class="btn">Все активные проекты
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="icon icon-arrow">
                            <use xlink:href="#arrow"></use>
                        </svg>
                    </a><a href="/projects/?pf-1=projectFilter_253_3918974738&set_filter=y&projectFilter_253_3918974738=Y">
