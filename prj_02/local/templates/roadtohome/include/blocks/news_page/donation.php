<section id="news-help" class="news-help">
    <div class="container">
        <form method="" action="" autocomplete="off" class="site-form main-help-item bg-orange">
            <div class="main-help-item__content">
                ...
                <div class="form-group">
                    <div class="buttons-line sum-line">
                        <input id="mhi-2-1" type="radio" name="mhi-2" value="1" checked class="custom-radio">
                        <label for="mhi-2-1" class="btn btn-orange-light label-like-btn">300 ₽</label>
                        <input id="mhi-2-2" type="radio" name="mhi-2" value="2" class="custom-radio">
                        <label for="mhi-2-2" class="btn btn-orange-light label-like-btn">500 ₽</label>
                        <input id="mhi-2-3" type="radio" name="mhi-2" value="3" class="custom-radio">
                        <label for="mhi-2-3" class="btn btn-orange-light label-like-btn">1 000 ₽</label>
                        <input type="text" name="mhi-3" value="" placeholder="Другая сумма" class="form-control form-control-sum">
                    </div>
                </div>
                <div class="form-group">
                    <div class="buttons-line submit-line">
                        ...
                        <button type="button" class="btn btn-white">Я хочу помочь
