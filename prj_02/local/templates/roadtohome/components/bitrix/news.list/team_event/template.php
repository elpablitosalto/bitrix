        ...
        <div class="container">
            <div class="projects-detail-team-slider">
                <div class="section__head">
                    ...
                    if (strlen($arParams["HEADER"]) > 0) {
                        $header = $arParams["HEADER"];
                    }
                    ?>
                    <h2 class="h3 section__title"><?= $header; ?></h2>
                ...
                <div class="swiper-container items-list">
                    <div class="swiper-wrapper">
                        ...
                        foreach ($arResult["ITEMS"] as $key => $item) {
                            ...
                            $position = "";
                            if (is_array($item["DISPLAY_PROPERTIES"]["EVENT_POSITION"]["DISPLAY_VALUE"])) {
                                foreach ($item["DISPLAY_PROPERTIES"]["EVENT_LINK"]["VALUE"] as $num => $projectID) {
                                    if ($projectID == $arParams["CURRENT_EVENT"]) {
                                        $position = $item["DISPLAY_PROPERTIES"]["EVENT_POSITION"]["DISPLAY_VALUE"][$num];
                                    }
                                }
                            } else $position = $item["DISPLAY_PROPERTIES"]["EVENT_POSITION"]["DISPLAY_VALUE"];
