...
if(!empty($arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["DISPLAY_VALUE"])) {
	$addrContent = $addrContent.'<p><span class="title">Адрес:</span><span itemprop="streetAddress">'.$arResult["DISPLAY_PROPERTIES"]["ADDRESS"]["DISPLAY_VALUE"].'</span></p>';
}
if(!empty($arResult["DISPLAY_PROPERTIES"]["PHONE_INFO"]["DISPLAY_VALUE"])) {
	...
	'<a href="tel:'.$arResult["DISPLAY_PROPERTIES"]["PHONE_INFO"]["DISPLAY_VALUE"].'"><u itemprop="telephone">'.$arResult["DISPLAY_PROPERTIES"]["PHONE_INFO"]["DISPLAY_VALUE"].'</u></a>'.
	'</p>';
}
if(!empty($arResult["DISPLAY_PROPERTIES"]["PHONE_911"]["DISPLAY_VALUE"])) {
	...
	'<a href="tel:'.$arResult["DISPLAY_PROPERTIES"]["PHONE_911"]["DISPLAY_VALUE"].'"><u itemprop="telephone">'.$arResult["DISPLAY_PROPERTIES"]["PHONE_911"]["DISPLAY_VALUE"].'</u></a>'.
	'</p>';
}
if(!empty($arResult["DISPLAY_PROPERTIES"]["EMAIL"]["DISPLAY_VALUE"])) {
	...
	'<a href="mailto:'.$arResult["DISPLAY_PROPERTIES"]["EMAIL"]["VALUE"].'"><u itemprop="email">'.$arResult["DISPLAY_PROPERTIES"]["EMAIL"]["VALUE"].'</u></a>'.
	'</p>';
}
