...
?>
    ...
    ?>
        ...
        <div class="container" id="<?= $this->GetEditAreaId($arResult['ID']); ?>">
            ...
            ?>
                <div class="section__content">
                    ...
                    if ($bShow) { ?>
                        <div class="buttons-line"><a href="#projects-detail-help" class="btn">Поддержать акцию</a></div>
                    <? } ?>
                </div>
                    ...
                    <div class="col-lg-7">
                        <div class="section__content">
                            <? if ($arParams["DISPLAY_NAME"] != "N" && $arResult["NAME"]) { ?>
                                <? if (!mb_strlen($arResult["DISPLAY_PROPERTIES"]["IS_GRANT_EVENT"]["VALUE"])) { ?>
                                    <h1 class="page-title"><?= $arResult["NAME"] ?></h1>
                                <? } else { ?>
                                                                        <h1 class="page-title"><?= $arResult["NAME"] ?></h1>
                                <? } ?>
            ...
            <div id="projects-categories" class="nav-tabs-container projects-categories">
                <ul class="text-size-lg nav-tabs">
                    ...
                    ?>
                        <li><a href="#projects-detail-about" data-scroll-to="#projects-detail-about"><?= $text; ?></a></li>
                    <? } ?>
                    ...
                    <? if (!empty($arResult["DISPLAY_PROPERTIES"]["HOW_WE_HELP"]["DISPLAY_VALUE"])) {
                        $text = "Как мы помогаем";
                        if ($arResult["ID"] == 25687) {
                            $text = "Основные правила";
                        }
                        if ($arResult["ID"] == 25771) {
                            $text = "Что мы делаем для специалистов";
                        }
                    ?>
                        <li><a href="#projects-detail-how-we-help" data-scroll-to="#projects-detail-how-we-help"><?= $text; ?></a></li>
                    <? } ?>
                    ...
                    ?>
                    <li class="team_link"><a href="#projects-detail-team" data-scroll-to="#projects-detail-team"><?= $text; ?></a></li>
                </ul>
            </div>
        </div>
        </section>
        ...
        <section id="projects-detail-hidden-nav" class="projects-detail-hidden-nav">
            <div class="container">
                <div class="buttons-line">
                    <div class="hidden-page-nav-wrapper"><a href="#projects-categories" data-toggle-activity="#btn-page-nav-popup" class="btn btn-white btn-page-nav open-popup xs-collapsed"><span>Разделы страницы</span>
                        ...
                        <div id="btn-page-nav-popup" data-close-on-outside-click="true" class="nav-tabs-container hidden-page-nav-popup">
                            <ul class="text-size-lg nav-tabs">
                                <? if (mb_strlen($arResult["DISPLAY_PROPERTIES"]["ABOUT"]["DISPLAY_VALUE"]) > 0) { ?>
                                    <li>
                                        <a href="#projects-detail-about" data-scroll-to="#projects-detail-about">
                                            Об акции
                                        </a>
                                    </li>
                                <? } ?>
                    ...
                    <a href="#projects-detail-share" data-toggle-activity="#projects-detail-share" class="btn btn-share">
            ...
            <section id="projects-detail-about" class="projects-detail-about">
                <div class="container">
                    ...
                    <div id="projects-detail-desc" class="section__desc">
                        ...
                        <?
                        if (
                            mb_strlen($arResult["DISPLAY_PROPERTIES"]["ABOUT"]["DISPLAY_VALUE"]) > 500
                            && $arResult["ID"] != 25687
                            && $arResult["ID"] != 25771
                        ) {
                        ...
                        ?>
                            <div class="h6 section__desc-inner"><?= $descArray[1][0] ?>
                            </div>
                            <div class="section__desc-default-hidden">
                                <div class="h6 section__desc-inner">
                                    <?= $descArray[1][1] ?>
                                </div>
                            </div>
                        ...
                        <? } else { ?>
                            <div class="h6 section__desc-inner"><?= $arResult["DISPLAY_PROPERTIES"]["ABOUT"]["DISPLAY_VALUE"] ?>
                            </div>
                        <?
                        } ?>
                    </div>
                        ...
                        <? if (!empty($arResult["DISPLAY_PROPERTIES"]["FOR_WHOM"]["DISPLAY_VALUE"])) { ?>
                            <div class="col-xl-6">
                                <div class="projects-detail-for">
                                    <?
                                    $text = "Для кого предназначена";
                                    if ($arResult["ID"] == 25687) {
                                        $text = "Направления конкурса";
                                    } ?>
                                    <h5 class="section__title"><?= $text; ?></h5>
                        ...
                        <? if (!empty($arResult["DISPLAY_PROPERTIES"]["DOCS"]["VALUE"])) { ?>
                            <div class="col-xl-6">
                                <div id="projects-detail-documents" class="projects-detail-documents">
                                    <?
                                    $text = "Документы акции";
                                    if ($arResult["ID"] == 25687) {
                                        $text = "Документы конкурса";
                                    } ?>
                                    <h5 class="section__title"><?= $text; ?></h5>
        ...
        <? if (!empty($arResult["DISPLAY_PROPERTIES"]["EVENT_BUDGET"]["DISPLAY_VALUE"])) { ?>
            <section class="projects-detail-digits">
                <div class="container">
                    <h3 class="section__title">Бюджет акции</h3>
                    <div class="items-list">
                        <div class="row">
                            <? foreach ($arResult["DISPLAY_PROPERTIES"]["EVENT_BUDGET"]["DISPLAY_VALUE"] as $arVal) { ?>
                                <div class="col-md-6">
                                    <div class="list-item main-digits-item">
                                        <div class="h2 main-digits-item__title"><?= $arVal["SUB_VALUES"]["EVENT_BUDGET_NUM"]["DISPLAY_VALUE"] ?></div>
                                        <div class="text-size-lg main-digits-item__text"><?= $arVal["SUB_VALUES"]["EVENT_BUDGET_TEXT"]["DISPLAY_VALUE"] ?></div>
                                        <? if (!empty($arVal["SUB_VALUES"]["EVENT_BUDGET_LOGO"]["FILE_VALUE"])) { ?>
                                            <div class="main-digits-item__logo">
                                                <picture><img src="<?= $arVal["SUB_VALUES"]["EVENT_BUDGET_LOGO"]["FILE_VALUE"]["SRC"] ?>" alt="<?= $arVal["SUB_VALUES"]["EVENT_BUDGET_LOGO"]["FILE_VALUE"]["FILE_NAME"] ?>" title="<?= $arVal["SUB_VALUES"]["EVENT_BUDGET_LOGO"]["FILE_VALUE"]["FILE_NAME"] ?>">
                                                </picture>
                                            </div>
                                        <? } ?>
                                    </div>
        ...
        <? } elseif (!empty($arResult["DISPLAY_PROPERTIES"]["EVENT_NUMBERS"]["DISPLAY_VALUE"])) { ?>
            <section class="projects-detail-digits">
                <div class="container">
                    <div class="items-list">
                        <div class="row">
                            <? foreach ($arResult["DISPLAY_PROPERTIES"]["EVENT_NUMBERS"]["DISPLAY_VALUE"] as $num => $val) { ?>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="list-item main-digits-item">
                                        <div class="h2 main-digits-item__title"><?= $val ?></div>
                                        <div class="text-size-lg main-digits-item__text"><?= $arResult["DISPLAY_PROPERTIES"]["EVENT_NUMBERS"]["DESCRIPTION"][$num] ?></div>
                                    </div>
                                </div>
                            <? } ?>
                        </div>
