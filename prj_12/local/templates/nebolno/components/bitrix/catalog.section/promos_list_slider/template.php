...
?>
<?/*?><div class="nb-stocks" data-entity="<?= $containerName ?>"><?*/ ?>
<?
//echo "ITEM_ROWS:";
//vardump($arResult['ITEM_ROWS']);
if (!empty($arResult['ITEM_ROWS'])) {
?>
	<section class="nb-section nb-stocks-section" id="<?= $arParams['BLOCK_AREA_ID'] ?>">
		<div class="container container-full" id="<?= $arParams['EDIT_AREA_ID'] ?>">
			<div class="nb-stocks">
				<div class="nb-stocks--slider-box">
					<div class="swiper-container nb-stocks--slider">
						<div class="swiper-wrapper nb-stocks--box">
						<?
					}
						?>
						...
						?>
							...
							?>
								...
								if (count($rowItems) === 1) {
								?>
									<div class="nb-stock nb-stock--red">
										<div class="nb-stock__link">
											<div class="nb-stock__main">
												<div class="nb-stock__top">
													<div class="nb-stock__label">Акция</div>
													<div class="nb-stock__price">ОЧЕВИДНО<span class="nb-stock__small-price-text">ВЫГОДНО</span></div>
												</div>
												<div class="nb-stock__content">
													<div class="nb-stock__title">Все текущие акции и предложения</div>
													<div class="nb-stock__limit">посмотреть все акции</div>
												</div>
												<div class="nb-stock__img"><img src="<?=SITE_TEMPLATE_PATH?>/img/design/nb-banner-action-img-2.png" alt=""></div>
												<div class="nb-stock__img_bottom"><img src="<?=SITE_TEMPLATE_PATH?>/img/design/nb-banner-action-img-3.png" alt=""></div>
											</div>
										</div>
									</div>
								<?
					...
					<div class="nb-stocks--controle nb-stocks--next">
					...
					<div class="nb-stocks--controle nb-stocks--prev">
					...
					<div class="nb-stocks--pagination"></div>
				</div>
			</div>
		</div>
	</section>
