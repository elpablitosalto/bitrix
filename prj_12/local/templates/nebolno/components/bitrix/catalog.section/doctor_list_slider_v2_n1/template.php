...
//$arResult['ITEMS_tmp'] = $arResult['ITEMS'];
//$arResult['ITEM_ROWS_tmp'] = $arResult['ITEM_ROWS'];
?>
<div class="nb-doctors nb-doctors-main-slider">
	<div class="nb-doctors__container" data-entity="<?= $containerName ?>">
		<?
		if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])) {
			$generalParams = [
				...
				'METRO_LIST' => $arResult['METRO_LIST']
			];
...
//vardump($arResult['ITEMS']);
//$arResult['ITEMS'] = $arResult['ITEMS_tmp'];
//$arResult['ITEM_ROWS'] = $arResult['ITEM_ROWS_tmp'];
?>
...
<?
/*
if ($arParams['TEMPLATE'] == 'slider' && !empty($request->getQuery("bxajaxid"))) : ?>
	<script>
		if (typeof doctorsSlider == 'function')
			doctorsSlider(document.querySelector('#comp_<?= $request->getQuery("bxajaxid") ?> .nb-doctors-slider'));
	</script>
<? endif; 
*/
?>
