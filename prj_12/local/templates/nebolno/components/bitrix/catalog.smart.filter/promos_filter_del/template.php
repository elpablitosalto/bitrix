								...
								?>
									<ul class="nb-dropdown__list">
										<li class="nb-dropdown__item">
											<input type="radio" value="" name="<? echo $arCur["CONTROL_NAME_ALT"] ?>" id="<? echo "all_" . $arCur["CONTROL_ID"] ?>" onclick="smartFilter.click(this)" class="nb-dropdown__input" <? if (!isset($arResult['CHECKED_ITEMS'][$arItem['CODE']])) : ?> checked<? endif; ?> />
											...
											?>
												<li class="nb-dropdown__item">
													<? if (isset($arItem["VALUES"][$arSpecializationItem['ID']])) : ?>
														<?
														?>
														<input type="radio" value="<? echo $ar["HTML_VALUE_ALT"] ?>" name="<? echo $ar["CONTROL_NAME_ALT"] ?>" id="<? echo $ar["CONTROL_ID"] ?>" <? echo ($ar["CHECKED"] || (count($arResult['CHECKED_ITEMS']) == 0) && $arParams["DEFAULT_SERVICE"] == $ar["FACET_VALUE"]) ? 'checked="checked"' : '' ?> onclick="smartFilter.click(this)" class="nb-dropdown__input" <? if ($ar["DISABLED"]) : ?>disabled<? endif; ?> />
										...
										<? else : ?>
											<? foreach ($arItem["VALUES"] as $val => $ar) : ?>
												...
												?>
												<li class="nb-dropdown__item">
													<input type="radio" value="<? echo $ar["HTML_VALUE_ALT"] ?>" name="<? echo $ar["CONTROL_NAME_ALT"] ?>" id="<? echo $ar["CONTROL_ID"] ?>" <? echo ($ar["CHECKED"] || (count($arResult['CHECKED_ITEMS']) == 0) && $arParams["DEFAULT_SERVICE"] == $ar["FACET_VALUE"]) ? 'checked="checked"' : '' ?> onclick="smartFilter.click(this)" class="nb-dropdown__input" />
...
<script type="text/javascript">
	var smartFilter<?=rand(1,1000000);?> = new JCSmartFilter('<? echo CUtil::JSEscape($arResult["FORM_ACTION"]) ?>', '<?= CUtil::JSEscape($arParams["FILTER_VIEW_MODE"]) ?>', <?= CUtil::PhpToJSObject($arResult["JS_FILTER_PARAMS"]) ?>);
</script>