...
?>
<section class="nb-top-banner-section nb-top-banner-doctors-section">
    <?
    // Формируется ниже в шаблоне catalog.element
    $APPLICATION->ShowViewContent("doctor_picture");
    ?>
    <?
    ...
    <?
    // Формируется ниже в шаблоне catalog.element
    $APPLICATION->ShowViewContent("doctor_banner");
    ?>
</section>
...
?>
<?
$GLOBALS['arPreFilterReviews'] = [
	'PROPERTY_DOCTORS' => $elementId
];

$APPLICATION->IncludeFile(
	SITE_DIR . 'include/review/review_list.php',
	array(
		"PREFILTER_NAME" => "arPreFilterReviews",
...
<?
$APPLICATION->IncludeFile(
	SITE_DIR . 'include/doctor/doctor_list.php',
	array(),
	array('SHOW_BORDER' => false)
);
?>
...
<?/* $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        // Мои параметры -->
        "THEME" => "dark",
        "H_FST_PART_D" => "Фотогалерея клиники «Белый кролик»",
        "H_SEC_PART_D" => "",
        "H_FST_PART_M" => "Фотогалерея клиники «Белый кролик»",
        "H_SEC_PART_M" => "",
    )
); */?>
<?
$GLOBALS['DOCTOR_ID_POPUP'] = $elementId;
?>