...
if ($arParams['TEMPLATE'] == 'slider_v2') {
    $ar_templates = array(
        'doctor_list_slider_v2_n1',
        'doctor_list_slider_v2_n2',
    );
}
$bSlider = $arParams['TEMPLATE'] == 'slider' || $arParams['TEMPLATE'] == 'slider_v2';
$PAGE_ELEMENT_COUNT = $bSlider ? "1000" : "6";
...
// <-- Фильтр по выбранной клинике в Контактах
foreach ($ar_templates as $template) {
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "DISPLAY_TOP_PAGER" => "N",
            "ELEMENT_SORT_FIELD" => ($bSlider ? "RAND" : "sort"),
            "ELEMENT_SORT_FIELD2" => ($bSlider ? "RAND" : "id"),
