...
?>
<section class="nb-f3-section" id="<?= $arParams['BLOCK_AREA_ID'] ?>">
	<div class="nb-f3">
		<div class="container" id="<?= $arParams['EDIT_AREA_ID'] ?>">
			<h2 class="nb-f3__title">Остались вопросы?</h2>
			<div class="nb-f3__desc nb-f3__desc_desktop">
				<p>Получить подробную информацию можно по&nbsp;телефону <a href="tel:+74957836606">+7 (495) 783-66-06</a> или&nbsp;закажите <span class="color_green">обратный звонок</span>, и&nbsp;мы перезвоним вам в&nbsp;ближайшее время:
				</p>
			</div>
			<div class="nb-f3__desc nb-f3__desc_mobile">Получите подробную информацию:</div>
			<span class="nb-f3__phone-wrapper"><span class="nb-f3__phone-icon">
				<svg class="icon icon-call ">
					<use xlink:href="#call"></use>
				</svg></span><a class="nb-f3__phone" href="tel:+74957836606">+7 (495) 783-66-06</a>
			</span>
			<form data-form-name="<?=htmlspecialchars($arResult['IBLOCK']['NAME'])?>" class="nb-form nb-consultation-form nb-f3-form" action="<?= $arResult['ACTION'] ?>" method="POST" <? if (!empty($arParams['FORM_CODE'])) : ?> data-form-code="<?= $arParams['FORM_CODE'] ?>" <? endif; ?>>
