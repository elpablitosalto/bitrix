...
?>
<section class="nb-f4-section" id="<?= $arParams['BLOCK_AREA_ID'] ?>">
	<div class="nb-f4" id="<?= $arParams['EDIT_AREA_ID'] ?>">
		<div class="container">
			<div class="nb-f4__inner">
				<div class="nb-f4__img">
					<img src="<?= SITE_TEMPLATE_PATH ?>/img/content/consultation/consultation-promo.png" alt="">
				</div>
				<div class="nb-f4__caption">
					<h2 class="nb-f4__title nb-f4__title_mobile"><span>Подробная информация</span> <span>и запись <span class="font-weight_bold">по акциям:</span></span>
					</h2>
					<p class="nb-f4__title nb-f4__title_desktop">Записаться <span class="color_pink">по&nbsp;акции:</span> <a class="nb-f4__title-phone" href="tel:+74957836606">+7 (495) 783-66-06</a>
					</p><span class="nb-f4__phone-wrapper"><span class="nb-f4__phone-icon">
							<svg class="icon icon-call ">
								<use xlink:href="#call"></use>
							</svg></span><a class="nb-f4__phone" href="tel:+74957836606">+7 (495) 783-66-06</a></span>
					<div class="nb-f4__desc nb-f4__desc_desktop">
						<p>Позвоните, или воспользуйтесь формой для обратной связи:</p>
					</div>
					<div class="nb-f4__desc nb-f4__desc_mobile">
						<p>Позвоните, или воспользуйтесь формой обратной связи, и мы свяжемся с вами:</p>
					</div>
					<form data-form-name="<?=htmlspecialchars($arResult['IBLOCK']['NAME'])?>" class="nb-form nb-consultation-form nb-f4-form" action="<?= $arResult['ACTION'] ?>" method="POST" <? if (!empty($arParams['FORM_CODE'])) : ?> data-form-code="<?= $arParams['FORM_CODE'] ?>" <? endif; ?>>
						...
						<div class="nb-form__footer">
							<p class="nb-form__agreement">
								<?= Loc::getMessage('FS_FORM_AGREEMENT') ?>
							</p>
						</div>
					</form>
				</div>
