...
<section class="nb-diagnostics-section" id="<?= $arParams['BLOCK_AREA_ID'] ?>">
	<div class="nb-diagnostics-section__inner" id="<?= $arParams['EDIT_AREA_ID'] ?>">
		<div class="nb-diagnostics-section__main">
			<div class="nb-diagnostics-block">
				<div class="nb-diagnostics-block__header">
					<h2 class="nb-diagnostics-block__title">Запишитесь к ведущему ортодонту.</h2>
					<p class="color_light-pink">Уже на первом приеме:</p>
				</div>
				<div class="nb-diagnostics-block__features">
					<ol class="nb-diagnostics-block__list">
						<li class="nb-diagnostics-block__list-item">
							<p class="nb-diagnostics-block__list-text"><span>Подберем оптимальную брекет-систему, учитывая вашу ситуацию и образ жизни</span></p>
						</li>
						<li class="nb-diagnostics-block__list-item">
							<p class="nb-diagnostics-block__list-text"><span>Смоделируем будущую улыбку и определим этапы лечения</span></p>
						</li>
						<li class="nb-diagnostics-block__list-item">
							<p class="nb-diagnostics-block__list-text"><span>Составим детальный план и предложим различные формы оплаты</span></p>
						</li>
					</ol>
				</div>
						...
						<div class="nb-form__body">
							<div class="nb-form__fields">
								<div class="nb-form-field">
									<input id="<?=toLower($arParams['FORM_CODE'] . '_PHONE')?>" type="tel" name="PHONE" <?=$strValidateAttrs;?> placeholder="+7 (999) 999-99-99">
									<label for="<?=toLower($arParams['FORM_CODE'] . '_PHONE')?>">Укажите ваш номер</label>
								</div>
							</div>
		...
		<div class="nb-diagnostics-section__img">
			<div class="nb-diagnostics-section__img-inner"><img src="<?=SITE_TEMPLATE_PATH?>/img/content/diagnostics/diagnostics-img-3.png" alt=""></div>
		</div>
	</div>
</section>