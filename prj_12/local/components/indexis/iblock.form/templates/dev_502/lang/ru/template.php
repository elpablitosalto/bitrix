...
$MESS['FS_FORM_AGREEMENT'] = 'Нажимая на кнопку, я соглашаюсь на обработку персональных данных в соответствии <span class="nb-form__agreement-rules">с&nbsp;<a href="/dokumenty/" target="_blank">условиями политики конфиденциальности</a></span>';
$MESS['FS_FORM_DESC'] = '<p>Получить более подробную информацию можно по телефону: +7 (495) 783-66-06</p><p class="color_green">Или заполните форму, чтобы с вами связался наш специалист</p>';
?>