$(function () {
	...
	//$('form[data-form-code="' + form_code + '"]').each(function () {
	$('form[data-form-code-doctor-popup]:not(.validate-installed)')
		...
		$(this).validate({
			...
			submitHandler: function (form) {
				var $form = $(form),
					...
					formCode = $form.data('form-code-doctor-popup');
				...
				$.ajax({
					...
					success: function (result) {
						if (typeof result.SUCCESS !== 'undefined') {
							...
							$('#modal-call').fadeOut(200, function () { $('#modal-call-success').fadeIn(300); });
							$form.trigger('reset');
