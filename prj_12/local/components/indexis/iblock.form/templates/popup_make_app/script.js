$(function () {
	...
	$('form[data-form-code-makeup-popup]:not(.validate-installed)')
		...
		$(this).validate({
			...
			submitHandler: function (form) {
				var $form = $(form),
					...
					formCode = $form.data('form-code-makeup-popup');
				...
				$.ajax({
					...
					success: function (result) {
						if (typeof result.SUCCESS !== 'undefined') {
							...
							//alert('!!!');
							$('#modal-call-makeup').fadeOut(200, function () { $('#modal-call-success').fadeIn(300); });
							$form.trigger('reset');
