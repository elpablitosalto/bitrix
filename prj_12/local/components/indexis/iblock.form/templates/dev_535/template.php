...
<section class="nb-diagnostics-section" id="<?= $arParams['BLOCK_AREA_ID'] ?>">
	<div class="nb-diagnostics-section__inner" id="<?= $arParams['EDIT_AREA_ID'] ?>">
		<div class="nb-diagnostics-section__main">
			<div class="nb-diagnostics-block">
				<div class="nb-diagnostics-block__header">
					<h2 class="nb-diagnostics-block__title">Узнайте, как будет выглядеть Ваша улыбка.</h2>
					<p class="color_light-pink">На приеме ортодонт:</p>
				</div>
				<div class="nb-diagnostics-block__features">
					<ol class="nb-diagnostics-block__list">
						<li class="nb-diagnostics-block__list-item">
							<p class="nb-diagnostics-block__list-text"><span>Расскажет, как работают элайнеры и в чем их преимущества</span></p>
						</li>
						<li class="nb-diagnostics-block__list-item">
							<p class="nb-diagnostics-block__list-text"><span>Смоделирует будущую улыбку и покажет этапы лечения в 3D</span></p>
						</li>
						<li class="nb-diagnostics-block__list-item">
							<p class="nb-diagnostics-block__list-text"><span>Составит детальный план под ваш бюджет</span></p>
						</li>
					</ol>
				</div>
		...
		<div class="nb-diagnostics-section__img">
			<div class="nb-diagnostics-section__img-inner"><img src="<?=SITE_TEMPLATE_PATH?>/img/content/diagnostics/diagnostics-img-2.png" alt=""></div>
		</div>
	</div>
</section>