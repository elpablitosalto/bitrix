...
if (!empty($GLOBALS["CUR_SERVICE_ID"])) {
    $GLOBALS[$arParams['FILTER_NAME']]['PROPERTY_SHOW_SERVICES'] = $GLOBALS["CUR_SERVICE_ID"];
}
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "ELEMENT_SORT_FIELD" => "property_SORT_SLIDER",
        ...
        "PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'100','BIG_DATA':false}]",
        ...
        "COMPONENT_TEMPLATE" => "promos_list_slider",
