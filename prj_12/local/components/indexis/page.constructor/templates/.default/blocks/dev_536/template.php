...
$APPLICATION->IncludeFile(
    SITE_DIR . 'include/form/dev_536.php',
    array(
        "FORM_CODE" => "FORM_BLOCK_" . $arParams['ITEM']['ID'],
        "EDIT_AREA_ID" => $arParams['EDIT_AREA_ID'],
        "BLOCK_AREA_ID" => $arParams['BLOCK_AREA_ID'],
        "PICTURE" => CFile::GetFileArray( $item['DISPLAY_PROPERTIES']['DEV_536_PICTURE']['VALUE'] ),
        "ITEMS" => $item['DISPLAY_PROPERTIES']['DEV_536_ITEMS']['VALUE'],
