<div class="nb-modal nb-modal_bg nb-modal-call nb-modal-feedback-success" id="modal-feedback-success">
	...
	<div class="nb-modal__dialog">
		...
		<div class="nb-modal__body">
			<p class="nb-modal-call__title nb-modal-call__title_mobile">Благодарны вам за этот отзыв!</p>
			...
			<div class="nb-modal-call__form">
				<div class="nb-modal-call__title nb-modal-call__title_desktop" style="font-weight:500">Благодарны вам за этот отзыв!</div>
