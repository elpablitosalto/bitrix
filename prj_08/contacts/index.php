...
$APPLICATION->SetPageProperty("PAGE_H3", 'Контакты');
$APPLICATION->SetPageProperty("PAGE_BODY_CLASS", 'dp-page-contacts');
?>
...
$APPLICATION->IncludeComponent(
  ...
  array(
    "SEF_MODE" => "N",
    "WEB_FORM_ID" => $GLOBALS["arSiteConfig"]["WEB_FORM"]['CONTACT_US'],
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "content",
    "IBLOCK_ID" => Indexis::getIblockId('contacts_sn', 'content'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => 'SORT',
    "SORT_ORDER1" => 'ASC',
    "SORT_BY2" => "SORT",
