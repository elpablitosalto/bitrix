...
$APPLICATION->SetPageProperty("PAGE_BODY_CLASS", 'dp-page-production');
?>
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "FIELD_CODE" => array("ID", 'NAME', 'CODE', 'DETAIL_TEXT', 'DETAIL_PICTURE', 'PREVIEW_TEXT', 'PREVIEW_PICTURE'),
    "PROPERTY_CODE" => array('HEADER', 'BLOCK_TYPE'),
    "CHECK_DATES" => "N",
    "DETAIL_URL" => "",
