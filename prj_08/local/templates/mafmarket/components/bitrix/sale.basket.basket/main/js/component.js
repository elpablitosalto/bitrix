...
BX.ready(function () {
    ...
    $body.on("click", ".dp-account-order-selected__remove", function (e) {
        console.log(312);
        e.preventDefault();
        $(".dp-account-order__checkbox input:checked").each(function() {
            $( this ).parents( ".dp-account-order__main" ).find(".dp-account-order__remove").click();
        });
    })

    $body.on("click", ".dp-account-order-submit", function (e) {
        e.preventDefault();
