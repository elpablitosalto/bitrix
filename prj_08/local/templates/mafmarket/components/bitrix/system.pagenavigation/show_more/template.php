...
<? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) { ?>
    <div id="<?= $idNav ?>">
        <a class="dp-btn dp-section__link js_more_items" href="#" data-id-nav="<?= $idNav ?>" data-nav-num="<?= $arResult["NavNum"] ?>" data-page-nomer="<?= $arResult["NavPageNomer"] ?>" data-max-page="<?= $arResult["NavPageCount"] ?>">
