...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => 'gallery',
    "IBLOCK_ID" => Indexis::getIblockId('intro', 'gallery'),
    "ELEMENT_ID" => "",
    "ELEMENT_CODE" => "gallery_intro",
    "CHECK_DATES" => "Y",
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "gallery",
    "IBLOCK_ID" => Indexis::getIblockId('subsections', 'gallery'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => "SORT",
    "SORT_ORDER1" => "ASC",
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "gallery",
    "IBLOCK_ID" => Indexis::getIblockId('news', 'gallery'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => "SORT",
    "SORT_ORDER1" => "ASC",
    "SORT_BY2" => "ACTIVE_FROM",
