...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "IBLOCK_ID" => Indexis::getIblockId('intro', 'contacts'),
    "ELEMENT_ID" => "",
    "ELEMENT_CODE" => "contacts_intro",
    "CHECK_DATES" => "Y",
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "contacts",
    "IBLOCK_ID" => Indexis::getIblockId('subsections', 'contacts'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => "SORT",
    "SORT_ORDER1" => "ASC",
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "contacts",
    "IBLOCK_ID" => Indexis::getIblockId('news', 'contacts'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => "SORT",
    "SORT_ORDER1" => "ASC",
    "SORT_BY2" => "ACTIVE_FROM",
