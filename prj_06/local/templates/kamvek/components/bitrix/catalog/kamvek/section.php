...
if (isset($arCurSection['ID']) && in_array($arResult['VARIABLES']['SECTION_CODE'], ['tekhnologiya-stone-top', 'tekhnologiya-color-mix'])) {
...
$intSectionID = $APPLICATION->IncludeComponent(
	...
	array(
		...
		'SECTION_USER_FIELDS' => array('UF_TOP_BANNER', 'UF_H2'),
	),
	$component
);
?>
