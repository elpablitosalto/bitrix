...
$APPLICATION->SetTitle('Забота и внимание');
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => 'about',
    "IBLOCK_ID" => Indexis::getIblockId('care_intro', 'about'),
    "ELEMENT_ID" => "",
    "ELEMENT_CODE" => "care_intro",
    "CHECK_DATES" => "Y",
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"AJAX_MODE" => "N",
		"IBLOCK_TYPE" => "about",
		"IBLOCK_ID" => Indexis::getIblockId("care","about"),
		"NEWS_COUNT" => "200",
		...
		"SECTION_HEADER" => "ЗАБОТА И ВНИМАНИЕ"
	),
	false
); ?>
