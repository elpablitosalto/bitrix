...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => 'service',
    "IBLOCK_ID" => Indexis::getIblockId('regulations_intro', 'service'),
    "ELEMENT_ID" => "",
    "ELEMENT_CODE" => "regulations_intro",
    "CHECK_DATES" => "Y",
    "FIELD_CODE" => array("ID", 'NAME', 'DETAIL_PICTURE', 'DETAIL_TEXT'),
    "PROPERTY_CODE" => array("H_2", 'IMAGES', 'TABLE_HEADER', 'TABLE', 'TABLE_AFTER_TEXT', 'RED_BLOCK'),
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"AJAX_MODE" => "N",
		"IBLOCK_TYPE" => "service",
		"IBLOCK_ID" => Indexis::getIblockId('regulations', 'service'),
		"NEWS_COUNT" => "200",
