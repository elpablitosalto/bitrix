...
$APPLICATION->SetTitle('Презентации');
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => 'service',
    "IBLOCK_ID" => Indexis::getIblockId('presentations_intro', 'service'),
    "ELEMENT_ID" => "",
    "ELEMENT_CODE" => "presentations_intro",
    "CHECK_DATES" => "Y",
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"AJAX_MODE" => "N",
		"IBLOCK_TYPE" => "service",
		"IBLOCK_ID" => Indexis::getIblockId("presentations","service"),
		"NEWS_COUNT" => "200",
		...
		"COMPONENT_TEMPLATE" => "presentations",
		"STRICT_SECTION_CHECK" => "N",
		"SECTION_HEADER" => "ЗАГРУЗКИ"
	),
	false
); ?>
