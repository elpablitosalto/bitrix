...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => 'service',
    "IBLOCK_ID" => Indexis::getIblockId('intro', 'service'),
    "ELEMENT_ID" => "",
    "ELEMENT_CODE" => "service_intro",
    "CHECK_DATES" => "Y",
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "service",
    "IBLOCK_ID" => Indexis::getIblockId('subsections', 'service'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => "SORT",
    "SORT_ORDER1" => "ASC",
    ...
    "PROPERTY_CODE" => array("URL", 'IMAGES'),
    "CHECK_DATES" => "N",
    "DETAIL_URL" => "",
...
<? $APPLICATION->IncludeComponent(
  ...
  array(
    ...
    "AJAX_MODE" => "N",
    "IBLOCK_TYPE" => "service",
    "IBLOCK_ID" => Indexis::getIblockId('news', 'service'),
    "NEWS_COUNT" => "200",
    "SORT_BY1" => "SORT",
    "SORT_ORDER1" => "ASC",
    "SORT_BY2" => "ACTIVE_FROM",
