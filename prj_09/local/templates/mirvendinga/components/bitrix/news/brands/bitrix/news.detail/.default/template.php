...
if(!empty($arResult['BRAND_PRODUCTS'])) {
	global $brandProductsFilter;
	$brandProductsFilter = Array('ID' => $arResult['BRAND_PRODUCTS']);
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"FILTER_NAME" => "brandProductsFilter",
			...
			"SHOW_MORE_CONTROL" => $arResult["SHOW_MORE_CONTROL"],
			"MORE_CONTROL_LINK" => "/catalog/",
			"MORE_CONTROL_TEXT" => "Смотреть все",
		),
		false
	);
	unset($brandProductsFilter);
}
?>