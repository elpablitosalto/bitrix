...
if ($arResult["isFormNote"] != "Y")
{
    ...
    if ($arUser = $rsUser->Fetch()) {
        $userFields['FULL_NAME'] = $arUser['LAST_NAME'].' '.$arUser['NAME'].' '.$arUser['SECOND_NAME'];
        $userFields['PERSONAL_PHONE'] = $arUser['PERSONAL_PHONE'];
        $userFields['EMAIL'] = $arUser['EMAIL'];
    }
?>
                                                ...
                                                <?else:?>
                                                    <input
                                                            <?if(!empty($arResult["arQuestions"][$FIELD_SID]["COMMENTS"]) && $arResult["arQuestions"][$FIELD_SID]["COMMENTS"] == "PHONE"):?>
                                                                ...
                                                                value="<?=$userFields['PERSONAL_PHONE'];?>"
                                                            ...
                                                            <?elseif(!empty($arResult["arQuestions"][$FIELD_SID]["COMMENTS"]) && $arResult["arQuestions"][$FIELD_SID]["COMMENTS"] == "DATE_PERIOD"):?>
                                                                type="text"
                                                                class="form-control__input js-date-period"
                                                            <?elseif(!empty($arResult["arQuestions"][$FIELD_SID]["COMMENTS"]) && $arResult["arQuestions"][$FIELD_SID]["COMMENTS"] == "PRODUCT"):?>
                                                                type="text"
                                                                class="form-control__input js-product-name-input"
                                                                value="<?=$APPLICATION->ShowTitle(false);?>"
                                                            <?elseif(!empty($FIELD_SID) && $FIELD_SID == "full_name"):?>
                                                                type="text"
                                                                class="form-control__input"
