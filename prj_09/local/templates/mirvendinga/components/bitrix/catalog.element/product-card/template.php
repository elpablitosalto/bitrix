								...
								<?if(!empty($arCatalogData["QUANTITY"]['REGION_QUANTITY']) ):?>
									<form class="product-card__final js_quantity_els_container">
												...
												<div class="quantity-input__wrapper js-quantity-container">
													<div class="quantity-input__control">
															<button 
																...
																class="quantity-input__button quantity-input__button_type_decrease js-quantity-decrease <?if( $arResult['IN_BASKET'] == 'Y' ){?>js_decrease_quantity<?}?>"
																data-product-id="<?=$arResult['ID']?>"
															>
																	Убавить
															</button>
													...
													<div class="quantity-input__field">
															<input 
																type="number" 
																value="<?=$basket->getBasketQuantityByProductId($arResult['ID'])?>" 
																min="<?=$min;?>" 
																max="<?=$arCatalogData["QUANTITY"]['REGION_QUANTITY']?>" 
																data-min="<?=$min;?>" 
																data-max="<?=$arCatalogData["QUANTITY"]['REGION_QUANTITY']?>" 
																class="quantity-input__input js-quantity-input <?if( $arResult['IN_BASKET'] == 'Y' ){?>js_input_quantity<?}?>" 
																data-last-val="1" 
																data-product-quantity="<?=$arResult['ID']?>" 
										...
										<div class="product-card__button">
												...
												<button
                                                        type="button"
                                                        class="button button_width_full button_icon-size_l button_text-size_l button_size_xl <?=($basket->isProductInBasket($arResult['ID']) ? 'button_state_alt-content' : '')?> js_button_add_to_basket"
