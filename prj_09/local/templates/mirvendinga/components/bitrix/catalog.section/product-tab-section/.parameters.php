...
$arTemplateParameters['MORE_LINK_URL'] = array(
	"NAME" => 'URL ссылки "подробнее"',
	"TYPE" => "TEXT",
	"DEFAULT" => null,
);

$arTemplateParameters['MORE_LINK_TEXT'] = array(
	"NAME" => 'Текст ссылки "подробнее"',
	"TYPE" => "TEXT",
	"DEFAULT" => null,
);

$arTemplateParameters['SHORT_PROPERTIES'] = array(
	'MULTIPLE' => 'Y',
