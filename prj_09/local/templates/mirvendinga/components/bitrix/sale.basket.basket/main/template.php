...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<div id="basket-root" class="section__cart">
		<div id="basket-warning" style="display: none;">
			<span data-entity="basket-items-warning-notification-close">&times;</span>
					...
					<div id="basket-items-list-container">
						...
						<div id="basket-item-list">
							...
							<div class="cart__header">
									<div class="cart__label cart__label_role_name">Товар</div>
									<div class="cart__label cart__label_role_price">Цена</div>
									<div class="cart__label cart__label_role_quantity">Количество</div>
									<div class="cart__label cart__label_role_sum">Сумма</div>
							</div>
							<div class="cart__products" id="basket-item-table"></div>
						</div>
					</div>
				</div>
			</div>
			<div class="cart__final" data-entity="basket-total-block"></div>
		</div>
		<?
		if (
...
<script>
	document.onreadystatechange = function () {
		if (document.readyState == "interactive") {
			var evt = new CustomEvent('order_begin', { detail: {} });
