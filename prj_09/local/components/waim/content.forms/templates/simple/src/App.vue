                    ...
                    <div class="form-panel__content">
                        <div class="form-panel__wrapper">
                            ...
                            <div class="form-panel__column">
                                ...
                                <div class="form-panel__line">
                                    <FormFile
                                      :allowMimeTypes="['application/pdf', 'image/png', 'image/jpeg', 'image/jpg']"
                                      v-model="form['file']"
...
export default {
  name: 'App',
  components: { FormControl, FormFile, RadioPanel },
  setup() {
  ...
  methods: {
    ...
    sendForm() {
      ...
      if (!this.v$.$invalid) {
        api.sendSimpleForm(this.formData).then((result) => {
          if (result.status) {
    ...
    clearForm() {
      ...
      Object.keys(this.form).map(key => {
        if (typeof this.userFields[key] === 'undefined') this.form[key] = null;
      });
    },
