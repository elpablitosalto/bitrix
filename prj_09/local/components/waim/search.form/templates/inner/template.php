...
?>
<!-- begin .search-form-->
<form class="search-form inner search-form_state_filled" method="GET" action="<?= $arResult['FORM_ACTION'] ?>">
	<div class="search-form__field">
		<input type="text" class="search-form__input js-search-with-results" name="q" placeholder="<?= $arResult['PLACEHOLDER'] ?>" value="<?= $arResult['SEARCH_QUERY'] ?>" />
