						...
						<div class="logo-carousel">
							<div class="logo-carousel__container swiper js-logo-carousel">
								<div class="logo-carousel__wrapper swiper-wrapper">
									<? foreach ($arResult["ITEMS"] as $arItem) { ?>
										...
										?>
										<div class="logo-carousel__slide swiper-slide" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
											<span class="logo-carousel__illustration" href="<?= $arItem['DETAIL_PAGE_URL']; ?>">
												<picture class="logo-carousel__picture">
													<img src="<?= $arItem['PREVIEW_PICTURE_SLIDER']['SRC']; ?>" alt="<?= $arItem['PREVIEW_PICTURE_SLIDER']["ALT"] ?>" title="<?= $arItem['PREVIEW_PICTURE_SLIDER']["TITLE"] ?>" class="logo-carousel__image" />
												</picture>
											</span>
										</div>
									<? } ?>									
							...
							<div class="logo-carousel__navigation">
								<div class="logo-carousel__arrows">
									<!-- begin .carousel-nav-->
									<div class="carousel-nav carousel-nav_position_sides js-carousel-nav" data-nav-scope=".logo-carousel" data-nav-target=".swiper">
										<div class="carousel-nav__control">
											<!-- begin .button-->
											<button class="button button_width_fit button_style_transparent js-carousel-nav-prev" type="button"><span class="button__holder"><svg class="button__icon" width="14" height="23" viewBox="0 0 14 23" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="carousel-nav__control">
											<!-- begin .button-->
											<button class="button button_width_fit button_style_transparent js-carousel-nav-next" type="button"><span class="button__holder"><svg class="button__icon" width="14" height="23" viewBox="0 0 14 23" fill="none" xmlns="http://www.w3.org/2000/svg">
