...
<? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) { ?>
    <div class="brands-grid__control" id="<?= $idNav ?>">
        <a class="button button_size_l button_width_full button_size_l button_width_full js_more_items" data-id-nav="<?= $idNav ?>" data-nav-num="<?= $arResult["NavNum"] ?>" data-page-nomer="<?= $arResult["NavPageNomer"] ?>" data-max-page="<?= $arResult["NavPageCount"] ?>">
            <span class="button__holder">Показать еще</span>
        </a>
    </div>
<? } ?>