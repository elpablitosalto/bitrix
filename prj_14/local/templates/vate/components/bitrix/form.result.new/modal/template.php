...
?>
    ...
    <?= str_replace('<form', '<form id="modalCallbackForm" class="form form_type_modal ' . $arResult["WEB_FORM_NAME"] . '"', $arResult["FORM_HEADER"]) ?>
    <script>
        (function() {
            window.addEventListener('load', function() {
                modalCallbackFormForm('<?= $templateFolder ?>/ajax.php')
            });
        })();
    </script>
    ...
    <div class="form__main">
        ...
        <div class="form__controls">
            <div class="form__control">
                <!-- begin .button-->
                <button class="button button_style_dark button_size_l button_width_modal button_style_dark button_size_l button_width_modal" type="submit">
