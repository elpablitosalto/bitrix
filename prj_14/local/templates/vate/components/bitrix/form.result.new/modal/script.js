"use strict";
function modalCallbackFormForm(link) {
  var feedbackForm = document.getElementById("modalCallbackForm");
      ...
      xhr.onload = function () {
        if (xhr.status != 200) {
          ...
          if (!json.success) {
            ...
            feedbackForm.closest('.modal').classList.add('modal_state_sent')
          }
        }
      };
