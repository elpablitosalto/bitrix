...
?>
    ...
    <?= str_replace('<form', '<form id="partnershipForm" class="form form_style_primary form_width_full ' . $arResult["WEB_FORM_NAME"] . '"', $arResult["FORM_HEADER"]) ?>
    <script>
        (function() {
            window.addEventListener('load', function() {
                ajaxPartnershipForm('<?= $templateFolder ?>/ajax.php')
            });
        })();
    </script>
    ...
    <div class="form__main">
                                            ...
                                            <span class="file-panel file-panel_type_form-control">
                                                <label class="file-panel__wrapper">
                                                    ...
                                                    <span class="file-panel__control">
                                                        <!-- begin .button-->
                                                        <span class="button button_width_full button_size_xs button_style_outline button_weight_normal">
        ...
        <div class="form__controls form__controls_style_primary">
            <div class="form__control">
                <!-- begin .button-->
                <button class="button button_style_dark button_size_l button_width_full button_style_dark button_size_l button_width_full" type="submit">
