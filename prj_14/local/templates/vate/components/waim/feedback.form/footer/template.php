...
<? if (!empty($arResult['GROUPS'])) : ?>
	<form class="form form_style_outline" id="<?= $arResult['FORM_ID'] ?>">
		<?= $arResult['FORM_META'] ?>
										...
										<? if (in_array($arItem['TYPE'], ['text', 'email', 'tel'])) : ?>
											<span class="form-control__field">
												<input
													...
													class="form-control__input form-control__input_style_transparent form-control__input_size_s <? if ($arItem['TYPE'] === 'tel'): ?>js-phone-input<? endif; ?>"
													name="<?= $name ?>">
