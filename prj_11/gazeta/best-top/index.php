...
$APPLICATION->SetTitle("Топовый топ");
?>
            ...
            <div class="section__filter">
                ...
                <div class="link-group link-group_layout_horizontal link-group_style_secondary">
                    <div class="link-group__title">
                        ...
                        <!-- end .title-->
                    </div><span class="link-group__subtitle">Лучшие статьи из всех рубрик</span>
                </div>
                <!-- end .link-group-->
            </div>
        </div>
            ...
            <div class="section__cards-panel">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "SORT_ORDER2" => "DESC",
                        "FILTER_NAME" => "gazetaBestTopFilter",
                        "FIELD_CODE" => array(
                            "NAME",
                            "PREVIEW_PICTURE",
                            "PREVIEW_TEXT",
