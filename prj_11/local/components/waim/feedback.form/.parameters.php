...
$arComponentParameters = Array(
	...
	"PARAMETERS" => Array(
		...
		"TITLE_HIGHLIGHT" => Array(
			"PARENT" => "BASE",
			"NAME" => "Верхняя часть заголовка",
			"TYPE" => "TEXT",
			"DEFAULT" => 'Свяжитесь',
		),
		"TITLE" => Array(
			"PARENT" => "BASE",
			"NAME" => "Нижняя часть заголовка",
			"TYPE" => "TEXT",
			"DEFAULT" => 'с нами',
		),
		"DESCRIPTION" => Array(
			...
			"NAME" => "Описание",
			"TYPE" => "TEXT",
			"DEFAULT" => 'Наш менеджер свяжется с вами и проконсультирует по деталям записи',
		),
		"BUTTON_TEXT" => Array(
			"PARENT" => "FORM",
			"NAME" => "Текст кнопки",
