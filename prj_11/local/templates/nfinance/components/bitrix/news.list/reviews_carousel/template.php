    ...
    <div class="section">
        <div class="section__header section__header_type_inline">
            <div class="section__title">
                <!-- begin .title-->
                <h2 class="title title_size_h2">Отзывы
                </h2>
                <!-- end .title-->
            </div>
            <div class="section__carousel-nav">
                <!-- begin .carousel-nav-->
                <div class="carousel-nav carousel-nav_position_sides js-carousel-nav" data-nav-scope=".section" data-nav-target=".swiper">
                    <div class="carousel-nav__control">
                        <!-- begin .button-->
                        <button class="button button_role_navigation js-carousel-nav-prev" type="button">
                    ...
                    <div class="carousel-nav__control">
                        <!-- begin .button-->
                        <button class="button button_role_navigation js-carousel-nav-next" type="button">
                            <span class="button__holder">
                                ...
                                <div class="reviews-carousel__slide swiper-slide"
                                    ...
                                    <div class="reviews-item">
                                        <a class="reviews-item__container js-modal"
                                          ...
                                          data-type="iframe"
                                        >
                                            <div class="reviews-item__illustration">
                                            ...
                                            <span class="reviews-item__content">
                                                <span class="reviews-item__title"><?= htmlspecialchars_decode($arItem["PROPERTIES"]["TITLE"]["VALUE"]["TEXT"]) ?></span>
                                                <span class="reviews-item__name"><?= $arItem["PROPERTIES"]["FIO"]["VALUE"] ?></span>
                                                <span class="reviews-item__sphere"><?= $arItem["PROPERTIES"]["INDUSTRY"]["VALUE"] ?></span>
                                            </span>
                                        </a>
                                    </div>
                                    <!-- end .reviews-item-->
