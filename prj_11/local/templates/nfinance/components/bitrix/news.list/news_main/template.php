        ...
        <div class="section section_space_top-close">
            <div class="section__header section__header_type_inline">
                <div class="section__title">
                    <!-- begin .title-->
                    <h2 class="title title_size_h2">Новости</h2>
                    <!-- end .title-->
                </div>
                <div class="section__extra">
                    <div class="section__link-item">
                        <!-- begin .link-item--><a
                                ...
                                href="/news/"><span class="link-item__label">Ко всем новостям</span>
                        ...
                        <div class="cards-panel__container">
                            <div class="cards-panel__wrapper">
                                <? foreach ($arResult["ITEMS"] as $arItem): ?>
                                    ...
                                    ?>
                                    <div class="cards-panel__item cards-panel__item_type_news" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                                        <!-- begin .news-item-->
                                        <div class="news-item news-item_type_panel cards-panel__panel">
                                                    ...
                                                    <div class="news-item__illustration">
                                                        <picture class="news-item__picture">
                                                            <img
                                                                    ...
                                                                    alt="<?= $arItem["NAME"] ?>" class="news-item__image"
                                                                    title=""
                                                            />
                                                        </picture>
                                                    </div>
