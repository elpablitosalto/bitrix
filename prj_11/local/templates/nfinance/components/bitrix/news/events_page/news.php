        ...
        <div class="section section_space_top-close">
            <div class="section__header section__header_type_inline section__header_gap_l">
              <div class="section__title">
                <!-- begin .title-->
                <h2 class="title title_size_h2 title_style_primary"><?$APPLICATION->ShowTitle()?></h2>
                <!-- end .title-->
              </div>
            ...
            if($request->isAjaxRequest() && !empty($request->get("event_type"))){
                $GLOBALS["eventsTypeFilter"] = [
                    "=PROPERTY_EVENT_TYPE" => intval($request->get("event_type"))
                ];
            }
            $GLOBALS["eventsTypeFilter"]['ACTIVE_DATE'] = 'Y';
            ?>
            <?$APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    "NO_ITEMS_MESSAGE" => $arParams["NO_ITEMS_MESSAGE"]
                ],
                $component
            );?>
        </div>
