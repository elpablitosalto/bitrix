...
<div class="page__section">
    ...
    if ($request->isAjaxRequest() && !empty($request->get("industry"))) {
        $GLOBALS["gazetaCasesFilter"] = [
            "=PROPERTY_INDUSTRY" => intval($request->get("industry"))
        ];
    }
    $APPLICATION->IncludeComponent(
        "bitrix:news.list",
        "gazeta_favorite_cases",
        array(
            "IBLOCK_TYPE" => "newspaper",
            "IBLOCK_ID" => "4",
            "PARENT_SECTION" => "5",
