...
// Создать новые ХК для элемента -->
//vardump($arResult["VARIABLES"]);
$arResultFunc = \First\Catalog::setNewBreadcrumbsInProductDetail(
    $arResult["VARIABLES"]["ELEMENT_CODE"],
    $arResult["VARIABLES"]["SECTION_CODE"]
);
if (!empty($arResultFunc['SET_NEW_CHAIN']) && $arResultFunc['SET_NEW_CHAIN'] == 'Y') {
...
<div class="catalog_detail" itemscope itemtype="http://schema.org/Product">
    <? $ElementID = $APPLICATION->IncludeComponent(
        ...
        ($arResult["HAS_OFFERS"]) ? "main_table-rd" : "main-rd",
        array(
    ...
    <div class="row mb-5 popul">
        <div class="col" data-entity="parent-container">
            ...
            <? $APPLICATION->IncludeComponent(
                ...
                'catalog_recommendations_slider-rd',
                array(
...
//
if (!empty($arResult['ANALOG_PRODUCTS'])) // 31559
{
    $GLOBALS["arAnalogsFilter"] = ["ID" => array_column($arResult["ANALOG_PRODUCTS"], "ID")];
    //
...
?>
    <div class="row mb-5 popul">
        <div class="col" data-entity="parent-container">
            ...
            <? $APPLICATION->IncludeComponent(
                'bitrix:catalog.section',
                'catalog_block_slider-rd',
                array(
                    "COMPATIBLE_MODE" => $arParams["COMPATIBLE_MODE"],
                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
                    'FILTER_NAME' => "arAnalogsFilter",
                    'ELEMENT_SORT_FIELD' => 'ID',
                    'ELEMENT_SORT_ORDER' => $GLOBALS["arAnalogsFilter"]["ID"],
                    'ELEMENT_SORT_FIELD2' => 'sort',
                    'ELEMENT_SORT_ORDER2' => 'asc',
                    'PROPERTY_CODE' => (isset($arParams['LIST_PROPERTY_CODE']) ? $arParams['LIST_PROPERTY_CODE'] : []),
                    'PROPERTY_CODE_MOBILE' => $arParams['LIST_PROPERTY_CODE_MOBILE'],
