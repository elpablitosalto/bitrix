...
if(!empty($arElement["PROPERTY_IMYA_KOMPLEKTA_ENUM_ID"])){
    $arRecommendationsFilter[1][] = ["PROPERTY_IMYA_KOMPLEKTA" => $arElement["PROPERTY_IMYA_KOMPLEKTA_ENUM_ID"]];
}
if(!empty($arElement["PROPERTY_IMYA_KOMPLEKTA_2_ENUM_ID"])){
    $arRecommendationsFilter[1][] = ["PROPERTY_IMYA_KOMPLEKTA_2" => $arElement["PROPERTY_IMYA_KOMPLEKTA_2_ENUM_ID"]];
}
if(!empty($arElement["PROPERTY_IMYA_KOMPLEKTA_3_ENUM_ID"])){
    $arRecommendationsFilter[1][] = ["PROPERTY_IMYA_KOMPLEKTA_3" => $arElement["PROPERTY_IMYA_KOMPLEKTA_3_ENUM_ID"]];
}
if(!empty($arRecommendationsFilter[1])){
    $arNames = array_filter([$arElement["PROPERTY_IMYA_KOMPLEKTA_VALUE"], $arElement["PROPERTY_IMYA_KOMPLEKTA_2_VALUE"], $arElement["PROPERTY_IMYA_KOMPLEKTA_3_VALUE"]]);
    if(!empty($arNames)) {
        $arQueryNames = [];
...
if(
    ...
    !empty($arElement["PROPERTY_IMYA_KOMPLEKTA_ENUM_ID"]) ||
    !empty($arElement["PROPERTY_IMYA_KOMPLEKTA_2_ENUM_ID"]) ||
    !empty($arElement["PROPERTY_IMYA_KOMPLEKTA_3_ENUM_ID"])
) {
