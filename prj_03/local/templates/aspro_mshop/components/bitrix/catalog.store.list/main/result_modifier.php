<?if($arResult["STORES"]):?>
	...
	if($arStoresIDs){
		$dbRes = CCatalogStore::GetList(array('ID' => 'ASC'), array('ID' => $arStoresIDs, 'ACTIVE' => 'Y'), false, false, array("ID", "SORT", "TITLE", "IMAGE_ID", "ADDRESS", "EMAIL", "DESCRIPTION", "UF_METRO", "UF_STORE_GROUP"));
