					...
					foreach ($arSource as $arProperties)
					{
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<div class="bx_block r3x1">
								<input type="<?=($arProperties["CODE"] == 'EMAIL' ? 'email' : 'text')?>" class="<?=($arProperties["REQUIED_FORMATED"]== "Y" ? 'required' : '')?> <?=($arProperties["CODE"] == 'PHONE' ? 'phone_mask' : '')?>" code="<?=$arProperties["CODE"]?>" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" />
