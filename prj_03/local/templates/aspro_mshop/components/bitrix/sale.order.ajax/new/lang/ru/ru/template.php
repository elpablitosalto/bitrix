...
$MESS['SOA_TEMPL_ORDER_SUC1'] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>.<br/> Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.<br/>Если вы оформили заказ впервые без регистрации, на указанную почту придет ссылка для входа в личный кабинет.";
