    ...
    if ($arResult["USER_VALS"]["CONFIRM_ORDER"] == "Y" || $arResult["NEED_REDIRECT"] == "Y") {
        if (strlen($arResult["REDIRECT_URL"]) > 0) {
            ...
            <script type="text/javascript">
                window.top.location.href = '<?= CUtil::JSEscape($arResult["REDIRECT_URL"]) ?>';</script>
            <?
            die();
        }
    }
    ...
    <div class="bx_order_make">
        ...
        <? endif ?>
                ...
                if ($_POST["is_ajax_post"] != "Y") {
                    ?><form action="<?= $APPLICATION->GetCurPage(); ?>" onsubmit="ym(36139370, 'reachGoal', 'goal_order_success')" method="POST" name="ORDER_FORM" id="ORDER_FORM" enctype="multipart/form-data">
                    <?= bitrix_sessid_post() ?>
                        ...
                        <div class="bx_ordercart_order_pay_center">
                            <p class="mr-3 display-inline">Нажимая кнопку &laquo;<?= GetMessage("SOA_TEMPL_BUTTON") ?>&raquo; Вы соглашаетесь с <a href="/politika-konfidentsialnosti.php" target="_blank">политикой конфиденциальности</a>.</p>
