						...
						*/?>
						...
						<?foreach ($arFields as $FIELD):?>
							...
							<?}?>
										...
										<?switch ($FIELD){
											case "PASSWORD":?>
												<input size="30" type="password" id="input_<?=$FIELD;?>" name="REGISTER[<?=$FIELD?>]" required value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="password form-control <?=(array_key_exists( $FIELD, $arResult["ERRORS"] ))? 'error': ''?>"  />

											<?break;
											case "CONFIRM_PASSWORD":?>
												<input size="30" type="password" id="input_<?=$FIELD;?>" name="REGISTER[<?=$FIELD?>]" required value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="confirm_password form-control <?=(array_key_exists( $FIELD, $arResult["ERRORS"] ))? 'error': ''?>" />
											...
											case "PERSONAL_PHOTO":
											case "WORK_LOGO":?>
												<input class="form-control" size="30" type="file" id="input_<?=$FIELD;?>" name="REGISTER_FILES_<?=$FIELD?>" />
												<?break;
											case "PERSONAL_NOTES":
											case "WORK_NOTES":?>
						...
						<?if ($arResult["USE_CAPTCHA"] == "Y"){?>
							<div class="form-group bg register-captcha captcha-row clearfix">
								<div class="iblock label_block2">
									...
									<div class="captcha_input">
										<input type="text" class="inputtext captcha form-control" name="captcha_word" size="30" maxlength="50" value="" required />
									</div>
								</div>
