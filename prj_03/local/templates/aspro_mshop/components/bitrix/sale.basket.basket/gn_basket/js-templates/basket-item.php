 ...
 */
$arParams['COLUMNS_LIST'][] = 'PROPS'; // 42017
		...
		{{^SHOW_RESTORE}}
			...
			<div class="basket-item-block-info">
				...
				<div class="basket-item-block-properties">
					...
					?>
										{{#PROPS}}
											<div class="basket-item-property<?= (!isset($mobileColumns['PROPS']) ? ' hidden-xs' : '') ?> {{{CODE}}}">
			...
			<td class="basket-items-list-item-amount">
				<div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}" data-entity="basket-item-quantity-block">
					...
					{{/SHOW_UPDATE_INPUT}}
					{{#SHOW_ONLY_QOUNT}}
						<input disabled type="text" class="basket-item-amount-filed" value="{{QUANTITY}}" {{#NOT_AVAILABLE}} disabled="disabled" {{/NOT_AVAILABLE}} data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field" id="basket-item-quantity-{{ID}}">
					{{/SHOW_ONLY_QOUNT}}
