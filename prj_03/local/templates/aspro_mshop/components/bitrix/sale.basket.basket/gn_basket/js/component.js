...
(function () {
    ...
    BX.Sale.BasketComponent = {
        ...
        showItemsCount: function ()
        {
            ...
            {
                itemCountNode.innerHTML = BX.message('SBB_IN_BASKET') + ' ' + (this.result.BASKET_ITEMS_COUNT - this.result.DELAYED_BASKET_ITEMS_COUNT) + ' ' + this.getGoodsMessage(this.result.BASKET_ITEMS_COUNT);
        ...
        createBasketItem: function (itemId)
        {
            ...
            let valueFilterAll = document.querySelector('.basket-items-list-header-filter > .active');
            
            
            if(valueFilterAll.dataset.filter === 'all' && this.items[itemId]['DELAYED'] === false) {
            ...
            } else if(valueFilterAll.dataset.filter === 'delayed' && this.items[itemId]['DELAYED'] === true) {
                var basketItemTemplate = this.getTemplate('basket-item-template');
                if (basketItemTemplate)
                {
                    var basketItemHtml = this.renderBasketItem(basketItemTemplate, this.items[itemId]);
