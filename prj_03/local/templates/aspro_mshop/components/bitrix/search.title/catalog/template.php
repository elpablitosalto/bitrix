	...
	<div id="<?echo $CONTAINER_ID?>" class="">
		<form action="<?echo $arResult["FORM_ACTION"]?>">
            <div class="input-group">
                <input id="<?echo $INPUT_ID?>" type="search" name="q" value="" size="40" class="form-control" maxlength="50" autocomplete="off" placeholder="<?=GetMessage("SEARCH_PLACEHOLDER");?>">
				<svg class="go-search__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input name="s" type="submit" class="go-search" value="<?=GetMessage("CT_BST_SEARCH_BUTTON");?>">
