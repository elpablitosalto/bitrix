...
if (count($arResult["ITEMS"]) >= 1) {
    ...
    ?>
    <ul class="recommendations_navigation slider_navigation top_big custom_flex border"></ul>
                                    ...
                                    <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>" class="thumb"
                                       id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>">
                                           ...
                                           <? if (!empty($arItem["PREVIEW_PICTURE"])): ?>
                                               <?
                                               $img = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array("width" => 170, "height" => 170), BX_RESIZE_IMAGE_PROPORTIONAL, true);
...
<script>
    $(document).ready(function () {
        ...
        $('.s_<?= $injectId; ?> .content_inner').flexslider({
            ...
            controlsContainer: '.recommendations_navigation',
