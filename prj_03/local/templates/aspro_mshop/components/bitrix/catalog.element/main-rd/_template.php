    ...
    <div class="right_info">
        <div class="info_item ">
            ...
            <div class="middle_info main_item_wrapper wrap_md">
                ...
                <div class="tm-element-block-bottom mt-3 row">

                    <? if ($arFiles): ?>

                        <div class="files_block col">
                    ...
                    <div class="row d-flex align-items-stretch">
                        ...
                        <? foreach ($arResult["PROPERTIES"]["ACCESSORIES"]["VALUE"] as $v => $value): ?>
                            ...
                            $rs = CIBlockElement::GetList(
                                ...
                                false,
                                false,
                                ['ID', 'IBLOCK_ID', 'LANG_ID', 'NAME', 'DETAIL_PAGE_URL', 'CATALOG_GROUP_4', 'DETAIL_PICTURE']
                            );
                            ...
                            if (!empty($acs["DETAIL_PICTURE"])) {
                                //Получаем изображения
                                $resPhotos = CFile::GetList(
                                    [],
                                    ["ID" => $acs["DETAIL_PICTURE"]]
                                );
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card">
                                    <a href="<?= $acs["DETAIL_PAGE_URL"]; ?>"
                                       class="d-flex justify-content-center mx-auto" style="height: 170px;">
                                        <img class="card-img-top img-fluid" src="<?= $photo1; ?>"
                                             alt="<?= $acs["NAME"] ?>">
                                    </a>
                                    <div class="card-body">
                                        <a href="<?= $acs["DETAIL_PAGE_URL"]; ?>" class="">
                                            <h6 class="card-title font-size-12"
                                                style="height: 50px;"><?= $acs["NAME"] ?></h6>
                                        </a>
                                        <?php
                                        ...
                                        <a href="<?= $acs["DETAIL_PAGE_URL"]; ?>" class="btn btn-primary btn-sm">Подробнее</a>
                                    </div>
                                </div>
                            </div>
