...
// 42017
$arPackData = \packHandler::getPackData($arResult["ID"]);
?>
...
<div class="item_main_info item_main_info--redesigned item_main_info--redesigned-further <?= (!$showCustomOffer ? "noffer" : ""); ?>" id="<?= $arItemIDs["strMainID"]; ?>">
    <div class="left_showcase">
        <div class="img_wrapper">
                        ...
                        <? elseif ($arResult["OFFERS"] && $arParams["TYPE_SKU"] === 'TYPE_1' && !empty($arResult['OFFERS_PROP'])): ?>
                            <div class="wish_item text " data-item="<?= $arResult["ID"] ?>"
                                ...
                                <span class="value pseudo <?= $arParams["TYPE_SKU"]; ?>"
                                    title="<?= GetMessage('CT_BCE_CATALOG_IZB') ?>"><span><?= GetMessage('CT_BCE_CATALOG_IZB') ?></span>
                                    <svg class="like_icons__icon" width="41.92" height="37.18" viewBox="0 0 41.92 37.18">
                                        <path d="M20.94,8l-3.37-3.3a9.69,9.69,0,0,0-7-1.6,9.11,9.11,0,0,0-5,2.53A9.24,9.24,0,0,0,3,11.7a10.18,10.18,0,0,0,1.86,6.42L20.94,34.18,37.46,17.39A10.13,10.13,0,0,0,38.92,12a9.52,9.52,0,0,0-3-6.8,9.33,9.33,0,0,0-4.18-2,9.74,9.74,0,0,0-4.22.12A10.15,10.15,0,0,0,24.07,4.9Z" />
                                    </svg>
                                </span>
                                <span class="value pseudo added <?= $arParams["TYPE_SKU"]; ?>"
                                    title="<?= GetMessage('CT_BCE_CATALOG_IZB_ADDED') ?>"><span><?= GetMessage('CT_BCE_CATALOG_IZB_ADDED') ?></span>
                                    <svg class="like_icons__icon" width="41.92" height="37.18" viewBox="0 0 41.92 37.18">
                                        <path d="M20.94,8l-3.37-3.3a9.69,9.69,0,0,0-7-1.6,9.11,9.11,0,0,0-5,2.53A9.24,9.24,0,0,0,3,11.7a10.18,10.18,0,0,0,1.86,6.42L20.94,34.18,37.46,17.39A10.13,10.13,0,0,0,38.92,12a9.52,9.52,0,0,0-3-6.8,9.33,9.33,0,0,0-4.18-2,9.74,9.74,0,0,0-4.22.12A10.15,10.15,0,0,0,24.07,4.9Z" />
                                    </svg>
                                </span>
            ...
            <div class="item_slider">
                    ...
                    <? if ($showCustomOffer && !empty($arResult['OFFERS_PROP'])) { ?>
                        <div class="offers_img wof">
                            ...
                            <? if ($arFirstPhoto["BIG"]["src"]) { ?>
                                <a href="<?= ($viewImgType == "IMG" ? $arFirstPhoto["BIG"]["src"] : "javascript:void(0)"); ?>"
                                    class="<?= $viewImgType == 'IMG' ? 'fancy_offer' : '' ?>" title="<?= $title; ?>">
                                    <img id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>"
                                        src="<?= $arFirstPhoto['SMALL']['src']; ?>" <?= ($viewImgType == "MAGNIFIER" ? 'class="zoom_picture" data-xpreview="' . $arFirstPhoto["SMALL"]["src"] . '" data-xoriginal="' . $arFirstPhoto["BIG"]["src"] . '"' : ""); ?>
                            ...
                            <ul>
                                ...
                                ?>
                                    ...
                                    <li id="photo-<?= $i ?>" <?= (!$i ? 'class="current"' : 'style="display: none;"') ?>>
                                        ...
                                        if (!$isEmpty) {
                                        ?>
                                            <a href="<?= ($viewImgType == "IMG" ? $arImage["BIG"]["src"] : "javascript:void(0)"); ?>" <?= ($bIsOneImage ? '' : 'data-fancybox-group="item_slider"') ?>
                                                class="<?= $viewImgType == 'IMG' ? 'fancy' : '' ?>" title="<?= $title; ?>">
                                                <img src="<?= $arImage["SMALL"]["src"] ?>" <?= ($viewImgType == "MAGNIFIER" ? 'class="zoom_picture" data-xpreview="' . $arImage["SMALL"]["src"] . '" data-xoriginal="' . $arImage["BIG"]["src"] . '"' : ""); ?>
                                                    alt="<?= $alt; ?>"
                ...
                <?
                if (!$showCustomOffer || empty($arResult['OFFERS_PROP'])) {
                    if (!empty($arResult["MORE_PHOTO"]) && is_array($arResult["MORE_PHOTO"]) && count($arResult["MORE_PHOTO"]) > 1):
                ?>
    ...
    <div class="right_info">
        <div class="info_item ">
            <? if (($arParams["DISPLAY_WISH_BUTTONS"] != "N" && $arResult["CAN_BUY"]) || ($arParams["DISPLAY_COMPARE"] == "Y") || strlen($arResult["DISPLAY_PROPERTIES"]["CML2_ARTICLE"]["VALUE"]) || $arResult["BRAND"]) { ?>
                <div class="top_info">
                    <div class="wrap_md">
                        <? if ($arResult["BRAND"]) { ?>
                            <div class="brand iblock">
                                <? if (!$arResult["BRAND"]["IMAGE"]): ?>
                                    <b class="block_title"><?= GetMessage("BRAND"); ?>:</b>
                                    <a href="<?= $arResult["BRAND"]["DETAIL_PAGE_URL"] ?>"><?= $arResult["BRAND"]["NAME"] ?></a>
                                <? else: ?>
                                    <a class="brand_picture" href="<?= $arResult["BRAND"]["DETAIL_PAGE_URL"] ?>">
                                        <img src="<?= $arResult["BRAND"]["IMAGE"]["src"] ?>"
                                ...
                                <div class="prices_block iblock">
                                        ...
                                        ?>
                                            <div class="with_matrix" style="display:none;">
                                                <div class="price price_value_block"><span
                                                        class="values_wrapper"><?= $minPrice["PRINT_DISCOUNT_VALUE"]; ?></span>
                                                </div>
                                        ...
                                        <? } else { ?>
                                            ...
                                            if (isset($arResult['PRICE_MATRIX']) && $arResult['PRICE_MATRIX']) { // USE_PRICE_COUNT
                                                ...
                                                */ ?>
                                                ...
                                                -->
                                                <? if (!empty($arResult["PRICE_MATRIX"]["MATRIX"][5]["ZERO-INF"]["PRINT_DISCOUNT_PRICE"])): ?>
                                                    <div class="prices_block">
                                                        <div class="prices_block_prefix">Розничная цена: </div>
                                                        <div class="cost prices clearfix">
                                                            <div class="with_matrix">
                                                                <div class="price price_value_block"><span
                                                                        class="values_wrapper">от <?= $arResult["PRICE_MATRIX"]["MATRIX"][5]["ZERO-INF"]["PRINT_DISCOUNT_PRICE"]; ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <? endif; ?>
                                                <? if (!empty($arResult["PRICE_MATRIX"]["MATRIX"][4]["ZERO-INF"]["PRINT_DISCOUNT_PRICE"])): ?>
                                                    <div class="prices_block">
                                                        <div class="prices_block_prefix">Оптовая цена: </div>
                                                        <div class="cost prices clearfix">
                                                            <div class="with_matrix">
                                                                <div class="price price_value_block"><span
                                                                        class="values_wrapper">от <?= $arResult["PRICE_MATRIX"]["MATRIX"][4]["ZERO-INF"]["PRINT_DISCOUNT_PRICE"]; ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <? if ($arParams["SHOW_CHEAPER_FORM"] == "Y"): ?>
                                        <div class="cheaper_form">
                                            <span class="animate-load cheaper"
                                                data-name="<?= CMShop::formatJsName($arResult["NAME"]); ?>"
                                                data-item="<?= $arResult['ID']; ?>"><?= ($arParams["CHEAPER_FORM_NAME"] ? $arParams["CHEAPER_FORM_NAME"] : GetMessage("CHEAPER")); ?></span>
                                        </div>
                                    <? endif; ?>
                            ...
                            <div class="tm-stock__line">
                                ...
                                <div class="tm-stock__label">
                                    <a href="#" data-target="modal"
                                        ...
                                        title="таблица размеров">Расширенный размерный ряд</a>
                                </div>
            ...
            <div class="middle_info main_item_wrapper wrap_md">
                <div class="buy_block iblock">
                    <? if ($arResult["OFFERS"] && $showCustomOffer) { ?>
                        <div class="sku_props">
                            ...
                            <? if (!empty($arResult['LINKED_PRODUCTS'])) { ?>
                                <div class="bx_catalog_item_scu wrapper_sku">
                                    <div class="bx_item_detail_size">
                                        <span class="show_class bx_item_section_name">Цвет</span>
                                        <ul>
                                            <?
                                            foreach ($arResult['LINKED_PRODUCTS'] as $linkedProduct) {
                                            ?>
                                                <li><a class="color_link" href="<?= (is_array($linkedProduct["DETAIL_PAGE_URL"]) ? current($linkedProduct["DETAIL_PAGE_URL"]) : $linkedProduct["DETAIL_PAGE_URL"]) ?>"><span><?= $linkedProduct["NAME"] ?></span></a></li>
                                            <?
                                            }
                                            ?>
                                        </ul>
                            ...
                            <? if (($arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] && $arAddToBasketData["ACTION"] == "ADD") && $arResult["CAN_BUY"]): ?>
                                <div class="counter_block big_basket"
                                    ...
                                    if (!empty($arPackData["MIN_PACK_VALUE"])) {
                                        $startQuantity = $arPackData["DEFAULT_PACK_VALUE"];
                                    } else {
                                    ...
                                    <input type="text" class="text"
                                        ...
                                        <? if (!empty($arPackData["MIN_PACK_VALUE"])) { ?>
                                        data-value-check-url="/ajax/check_product_quantity.php"
                                        <? } ?>
                                    ...
                                    <span class="plus"
                                        id="<? echo $arItemIDs["ALL_ITEM_IDS"]['QUANTITY_UP']; ?>" <? //= ($arAddToBasketData["MAX_QUANTITY_BUY"] ? "data-max='" . $arAddToBasketData["MAX_QUANTITY_BUY"] . "'" : "") 
                                                                                                    ?>>+</span>
                                </div>
                            <? endif; ?>
                    ...
                    <? if (!empty($arPackData["MIN_PACK_VALUE"])): ?>
                        <div class="min_pack">
                            Минимальная упаковка: <span><?= $arPackData["MIN_PACK_VALUE"] ?></span> шт
                            <? if (!empty($arPackData["MIN_PACK_VALUE_MESSAGE"]) && !empty($arPackData["MIN_PACK_VALUE_PRICE"])): ?>
                                <div class="min_pack_message"><?= ($arPackData["MIN_PACK_VALUE_MESSAGE"] . " " . $arPackData["MIN_PACK_VALUE_PRICE"]) ?> руб.</div>
                            <? endif; ?>
                        </div>
                    <? endif ?>
                </div>
                ...
                <div class="tm-element-block-bottom mt-4 row">
                    ...
                    <? if ($arFiles): ?>
                        ...
                        <div class="files_block col-8">
                            <span class="mb-3 font-size-12"><?= GetMessage("DOCUMENTS_TITLE") ?>: </span>
                            <div class="wrap_md">
            ...
            <? foreach ($arResult['OFFERS'] as $arOffer): ?>
                ...
                <span id="<?= $arItemIDs['ALL_ITEM_IDS']['OFFER_GROUP'] . $arOffer['ID'] ?>" style="display: none;">
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        CMShop::checkVersionExt("main", "catalog", "Y"),
                        array(
...
<div class="tabs_section">
    ...
    <ul class="tabs_content tabs-body">
        ...
        <? if ($arResult["DETAIL_TEXT"] || !empty($arResult["STOCK"]) || !empty($arResult["SERVICES"]) || ((!empty($arResult["PROPERTIES"][$docs_prop_code]["VALUE"]) && is_array($arResult["PROPERTIES"][$docs_prop_code]["VALUE"])) || !empty($arResult["SECTION_FULL"]["UF_FILES"])) || ($showProps && $arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB")): ?>
            <li class="<?= (!($iTab++) ? ' current' : '') ?>">
                <div class="row">
                    <div class="download_group" style="display: none">
                            ...
                            <ul class="download-group__list">
                                <li class="download-group__item">
                                    <div class="download-item">
                                        ...
                                        <div class="download-item__body">
                                            <div class="download-item__label">Заключение Минпроторга</div>
                                ...
                                <li class="download-group__item">
                                    <div class="download-item">
                                        ...
                                        <div class="download-item__body">
                                            <div class="download-item__label">Сертификат качества</div>
                                            <a href="#" class="download-item__link">
                                                <svg class="download-item__link-icon" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.75 7.00233V12.25H12.25V7" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M9.625 6.70831L7 9.33331L4.375 6.70831" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                                        ...
                                                        <div class="char_name">
                                                            <span
                                                                <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y") { ?>class="whint" <? } ?>><? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y"): ?>
                                                                    ...
                                                                    itemprop="name"><?= ($arProp["~NAME"] ? $arProp["~NAME"] : $arProp["NAME"]); ?></span>
                                                            </span>
                                                        </div>
