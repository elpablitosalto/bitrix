...
<meta itemprop="description"
    ...
    <? if ($arResult['PROPERTIES']['RASPRODAT']['VALUE'] === 'Да'): ?>
        ...
        <style>
            ...
            .sku_props, .info_item .middle_info .buy_block .sku_props + .counter_wrapp, .info_item .middle_info .buy_block .buys_wrapp, .info_item .middle_info .buy_block {
                pointer-events: none;
                opacity: .6;
            }
        </style>
                                        ...
                                        <div class="font-size-14 tableSizes mb-2">
                                            ...
                                            <div class="page-wrapper">
                                                ...
                                                <a href="#" data-target="modal"
                                                   class="text-decoration-underline tm-table-sizes"
                                                        ...
                                                        <div class="char_name">
                                                            <span
                                                                <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y") { ?>class="whint"<? } ?>><? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y"): ?>
                                                                    ...
                                                                    itemprop="name"><?= ($arProp["~NAME"] ? $arProp["~NAME"] : $arProp["NAME"]); ?></span></span>
                                                        </div>
