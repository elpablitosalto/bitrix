...
<div class="item_main_info item_main_info--redesigned <?= (!$showCustomOffer ? "noffer" : ""); ?>" id="<?= $arItemIDs["strMainID"]; ?>">
    <div class="left_showcase">
        ...
        <div class="left_props sku_props">
            ...
            <div class="mobile-information">
                <div class="mobile-information__article">
                ...
                <div class="mobile-information__price">
                ...
                <div class="mobile-information__table">
                    <div class="tm-stock">
                        <?php
                        if ($arResult["PROPERTIES"]["TABLITSA_RAZMEROV"]["VALUE"] == "y") {
                        ?>

                            <div class="font-size-14 tableSizes mb-2">
                                <!-- КНОПКА-->
                                <div class="page-wrapper">
                                    <i class="icon"></i>
                                    <a href="#" data-target="modal" class="text-decoration-underline tm-table-sizes" title="таблица размеров">таблица размеров</a>
                                </div>
                            </div>
                ...
                <div class="mobile-information__label">
                    <?php
                    if (!empty($arResult["PROPERTIES"]["GOST_1"]["VALUE"])) {
                    ?>
                        ГОСТ: <?= $arResult["PROPERTIES"]["GOST_1"]["VALUE"] ?>
                    <?php
                    }
                    ?>
                </div>
                                    ...
                                    <div class="size-table">
                                        <div class="size-table__head">
                                            <div class="size-table__row">
                                                ...
                                                <div class="size-table__heading size-table__desktop-only">Доступно на складе<span class="size-table__note">(срок поставки<br>5-10 дней)</span></div>
                                        ...
                                        <div class="size-table__body">
                                            <? foreach ($arResult["OFFERS"] as $offer) : ?>
                                                <div class="size-table__row" data-item="<?= $offer["ID"] ?>">
                                                    ...
                                                    <div class="size-table__cell size-table__desktop-only">
                                                        <?
                                                        //$str = 'Под заказ';
                                                        $str = 'По запросу';
                                                        ?>
                                                        <?= (intval($offer["PRODUCT"]["QUANTITY"]) == 0 ? $str : ($offer["STORES"][113]["AMOUNT"] + $offer["STORES"][117]["AMOUNT"]) . '<span class="size-table__additional">(+' . $offer["STORES"][112]["AMOUNT"] . ')</span>') ?>
                                                    ...
                                                    <div class="size-table__cell">
                                                        <div class="counter_block counter_block_slim basket">
                                                            ...
                                                            <input type="text" class="text js-size-table-quantity" name="quantity" value="0">
                                                            <span class="plus" data-max="<?= intval($offer["PRODUCT"]["QUANTITY"]) ?>">+</span>
                                                        </div>
                                                    </div>
                                                    <div class="size-table__cell">
                                                        <label class="size-table__checkbox">
                                                            <input type="checkbox" class="size-table__checkbox-input js-size-table-checkbox">
