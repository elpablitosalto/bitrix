...
// 27068
if(!empty($arResult["PROPERTIES"]["IMYA_KOMPLEKTA"]["VALUE_ENUM_ID"]) && !empty($arResult["PROPERTIES"]["TIP_IZDELIYA"]["VALUE_ENUM_ID"])){
	$arLinkedProducts = CMshopCache::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"Y", "TAG" => CMshopCache::GetIBlockCacheTag($arResult["ID"]))), array(
		"!ID" => $arResult["ID"], 
		"IBLOCK_ID" => $arResult["IBLOCK_ID"], 
		"PROPERTY_IMYA_KOMPLEKTA" => $arResult["PROPERTIES"]["IMYA_KOMPLEKTA"]["VALUE_ENUM_ID"],
		"PROPERTY_TIP_IZDELIYA" => $arResult["PROPERTIES"]["TIP_IZDELIYA"]["VALUE_ENUM_ID"],
		"PROPERTY_SEZON" => $arResult["PROPERTIES"]["SEZON"]["VALUE_ENUM_ID"]
	));
	$arResult["LINKED_PRODUCTS"] = $arLinkedProducts;
}
?>