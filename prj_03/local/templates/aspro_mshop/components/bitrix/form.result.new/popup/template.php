...
<div class="form <?= $arResult["arForm"]["SID"] ?>">
    ...
    <? } else { ?>
        ...
        <div class="form_footer">
            ...
            <p class="mt-3">Нажимая кнопку &laquo;<?= $arResult["arForm"]["BUTTON"] ?>&raquo; Вы соглашаетесь с <a href="/politika-konfidentsialnosti.php" target="_blank">политикой конфиденциальности</a>.</p>
        </div>
