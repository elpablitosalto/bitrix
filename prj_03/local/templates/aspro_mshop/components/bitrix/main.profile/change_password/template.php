			...
			<div class="form-group">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input required type="password" name="NEW_PASSWORD" maxlength="50" value="" id='pass' autocomplete="off" class="bx-auth-input password form-control" />
					</div>
			...
			<div class="form-group">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input required class="form-control" type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" autocomplete="off" />
					</div>
				</div>
			</div>
