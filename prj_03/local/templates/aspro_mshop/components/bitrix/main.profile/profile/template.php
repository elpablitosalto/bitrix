		...
		<form method="post" name="form1" class="main" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
			...
			<?else:?>
				<div class="form-group2">
					<div class="wrap_md">
						<div class="iblock label_block form-group">
							<label><?=GetMessage("LOGIN")?><span class="star">*</span></label>
							<input class="form-control" required type="text" name="LOGIN" required value="<?=$arResult["arUser"]["LOGIN"]?>" />
						</div>
					</div>
				</div>
			<?endif?>
			...
			<div class="form-control2">
				<div class="wrap_md">
					<div class="iblock label_block form-group">
						...
						?>
						<input class="form-control" required type="text" name="NAME" maxlength="50" value="<?=implode(' ', $arName);?>" />
					</div>
			...
			<div class="form-group">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input required type="text" name="PERSONAL_PHONE" class="phone form-control" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-group">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input class="form-control" required type="text" name="EMAIL" maxlength="50" placeholder="name@company.ru" value="<? echo $arResult["arUser"]["EMAIL"]?>" />
					</div>
					<div class="iblock text_block">
						<?if($sLoginEqual !='Y'):?>
