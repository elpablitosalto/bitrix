						...
						<div class="form_wrapp">
							<form id="avtorization-form-page" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=SITE_DIR?>auth/<?=!empty( $_REQUEST["backurl"] ) ? '?backurl='.$_REQUEST["backurl"] : ''?>">
								...
								<div class="r form-group">
									...
									<input type="text" class="form-control" name="USER_LOGIN" required maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" size="17" tabindex="7" />
								...
								<div class="r form-group">
									...
									<input type="password" class="password form-control" name="USER_PASSWORD" required maxlength="50" size="17" tabindex="8" />
