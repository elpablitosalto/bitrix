...
<? if ($arResult["ITEMS"]) : ?>
    <div class="top_slider_wrapp" <?/*?>style="min-height: 500px !important;"<?*/?>>
        <div class="flexslider">
            <ul class="slides">
                ...
                <? foreach ($arResult["ITEMS"] as $arItem) : ?>
                    ...
                    ?>
                    <li class="slide-<?= $i; ?> box<?= ($arItem["PROPERTIES"]["TEXTCOLOR"]["VALUE_XML_ID"] ? " " . $arItem["PROPERTIES"]["TEXTCOLOR"]["VALUE_XML_ID"] : ""); ?><?= ($arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] ? " " . $arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] : " left"); ?>" data-nav_color="<?= ($arItem["PROPERTIES"]["NAV_COLOR"]["VALUE_XML_ID"] ? $arItem["PROPERTIES"]["NAV_COLOR"]["VALUE_XML_ID"] : ""); ?>" <?/*?>
                        ...
                        <span data-picture data-alt="Description here...">
                            <span data-src="<?= SITE_TEMPLATE_PATH ?>/images/1x1.png" data-original="<?= $arItem['BACKGROUND_540'] ?>">
                            </span>
                            <span data-src="<?= SITE_TEMPLATE_PATH ?>/images/1x1.png" data-original="<?= $arItem['BACKGROUND_540'] ?>" data-media="(max-width: 540px)">
                            </span>
                            <span data-src="<?= SITE_TEMPLATE_PATH ?>/images/1x1.png" data-original="<?= $arItem['BACKGROUND_720'] ?>" data-media="(min-width: 541px) and (max-width: 720px)">
                            </span>
                            <span data-src="<?= SITE_TEMPLATE_PATH ?>/images/1x1.png" data-original="<?= $arItem['BACKGROUND_900'] ?>" data-media="(min-width: 721px) and (max-width: 900px)">
                            </span>
                            <span data-src="<?= SITE_TEMPLATE_PATH ?>/images/1x1.png" data-original="<?= $arItem['BACKGROUND'] ?>" data-media="(min-width: 901px)">
                            </span>
                            <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                            <noscript>
                                <img src="<?= $arItem['BACKGROUND_540'] ?>" alt="Description here...">
                            </noscript>
                        </span>
                        <?
                        // <-- LazyLoad
