...
<div class="flexslider">
  <ul class="slides">
    <li class="slide slide-16 clone">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/1x1.png" data-original="img/slideshow/16.jpg">
    </li>
    <li class="slide slide-01">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/1x1.png" data-original="img/slideshow/01.jpg">
    </li>
    <li class="slide slide-02">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/1x1.png" data-original="img/slideshow/02.jpg">
    </li>
    <li class="slide slide-03">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/1x1.png" data-original="img/slideshow/03.jpg">
    </li>
    <li class="slide slide-04">
      <img src="<?=SITE_TEMPLATE_PATH?>/images/1x1.png" data-original="img/slideshow/04.jpg">
    </li>
    ...
  ...
  <ul class="slides">
    <li>
      <span data-picture data-alt="Description here...">
        <span
          data-src="<?=SITE_TEMPLATE_PATH?>/images/1x1.png"
