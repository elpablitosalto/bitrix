...
<input type="hidden" id="js_template_path_partnership" value="<?= $this->getFolder(); ?>/ajaxSendForm.php" />

<div class="contacts__form-panel js_partnership_container">
	<div class="contacts__subtitle">
		<!-- begin .title-->
		<h2 class="title title_size_h4 title_font_secondary">
			<?= GetMessage('FORM_PARTNERSHIP'); ?>
		</h2>
		<!-- end .title-->
	</div>
	<div class="contacts__note contacts__note_size_l">
		<?= GetMessage('FORM_FILL_OUT_THE_FORM'); ?>
	</div>
	<div class="contacts__form">
		...
		<? if ($arResult["isFormNote"] != "Y") { ?>
			<?
			$arResult['FORM_HEADER'] = str_replace('<form', '<form class="form js-demo-validated-form_" id="js_partnership_form" target="_self" ', $arResult['FORM_HEADER']);
			?>
			<?= $arResult["FORM_HEADER"] ?>
		<? } ?>
		<!-- messages can be placed before or after the form-->
		<div class="form__messages" id="js_partnership_form_messages">
			<div class="form__message form__message_style_error" id="js_partnership_form_error_message">
		...
		<div class="form__main">
			...
			<div class="form__confirmation-check">
				<!-- begin .check-elem-->
				<label class="check-elem"><input class="check-elem__input js-disabling-checkbox" type="checkbox" name="confirm" />
			...
			<div class="form__controls">
				<div class="form__control">
					<!-- begin .button-->
					<button class="button button_width_full button_size_l button_text_size-l" type="submit" id="js_partnership_form_send_button">
		...
		<div class="form__final" id="js_partnership_form_success_message">
			<!-- begin .result-panel-->
