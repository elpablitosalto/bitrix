                    ...
                    <div class="section__header-container page__container">
                        <div class="section__title">
                            ...
                            <h2 class="title title_size_h2 title_font_secondary title_align_center title_weight_bold">
                                <?= GetMessage('RELATED_PRODUCT_WE_RECOMMEND') ?>
                            </h2>
                            <!-- end .title-->
                        </div>
                    </div>
                                ...
                                <div class="entry-carousel__container swiper js-entry-carousel">
                                    <div class="entry-carousel__wrapper swiper-wrapper">
                                        <? foreach ($arResult['ITEMS'] as $k => $arItem) { ?>
                                            ...
                                            ?>
                                            <div class="entry-carousel__slide swiper-slide" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                                                <!-- begin .entry-snippet-->
                                                <div class="entry-snippet entry-carousel__snippet" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
