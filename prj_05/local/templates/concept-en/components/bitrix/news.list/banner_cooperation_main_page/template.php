        ...
        <div class="page__container">
            <? foreach ($arResult["ITEMS"] as $arItem) { ?>
                ...
                <? if (!empty($arItem["DISPLAY_PROPERTIES"]['LINK']['VALUE'])) { ?>
                    <a href="<?= $arItem["DISPLAY_PROPERTIES"]['LINK']['VALUE'] ?>" class="banner banner_height_auto" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                    <? } else { ?>
                        <div class="banner banner_height_auto" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                        <? } ?>
