...
<? if (!empty($arResult['SECTIONS'])) { ?>
    <div class="page__info-carousel">
        <div class="page__container">
            <!-- begin .info-carousel-->
            <div class="info-carousel">
                <div class="info-carousel__container swiper js-info-carousel">
                    <div class="info-carousel__wrapper swiper-wrapper">
                        <? foreach ($arResult['SECTIONS'] as $k => $arSection) { ?>
                            <?
                            $this->AddEditAction($arSection['ID'], $arSection['EDIT_LINK'], $strSectionEdit);
                            $this->AddDeleteAction($arSection['ID'], $arSection['DELETE_LINK'], $strSectionDelete, $arSectionDeleteParams);
                            ?>
                            <div class="info-carousel__slide swiper-slide" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
                                <!-- begin .info-panel-->
                                <div class="info-panel info-carousel__info-panel">
                                    <div class="info-panel__holder">
                                        <div class="info-panel__illustration">
                                            <picture class="info-panel__picture">
                                                <img src="<?= $arSection['DETAIL_PICTURE_SLIDER']['SRC']; ?>" alt="<?= $arSection['DETAIL_PICTURE_SLIDER']["ALT"] ?>" title="<?= $arSection['DETAIL_PICTURE_SLIDER']["TITLE"] ?>" class="info-panel__image" />
                                            </picture>
                                        </div>
                                        <div class="info-panel__content">
                                            <div class="info-panel__header">
                                                <h2 class="info-panel__title"><?= $arSection['NAME']; ?>
                                                </h2>
                                            </div>
                                            <div class="info-panel__text">
                                                <p><?= $arSection['~UF_SLIDER_TEXT'] ?></p>
                                            </div>
                                            <div class="info-panel__controls">
                                                <!-- begin .button-->
                                                <a class="button button_width_full button_size_l button_text_size-m button_text_tall info-panel__control info-panel__info-panel" href="<?= $arSection['SECTION_PAGE_URL'] ?>"><span class="button__holder">Learn more</span></a>
                                                <!-- end .button-->
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <button class="info-carousel__arrow info-carousel__arrow_position_left js-info-carousel-prev" type="button">
                        <svg class="info-carousel__icon" width="9" height="18" viewbox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="info-carousel__arrow info-carousel__arrow_position_right js-info-carousel-next" type="button">
                        <svg class="info-carousel__icon" width="9" height="18" viewbox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
