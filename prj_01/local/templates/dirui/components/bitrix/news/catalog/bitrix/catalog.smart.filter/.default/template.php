    ...
    foreach ($arResult["ITEMS"] as $key => $arItem) {
        ...
        switch ($arItem["DISPLAY_TYPE"]) {
            default://CHECKBOXES
                ...
                <div class="catalog-small-links">
                    <div class="catalog-small-links__item<?if($nonChecked){?> catalog-small-selected<?}?>"><a href="<?= $arParams['CUR_FOLDER'] ?>#filter-start">Вся продукция</a>
                        <span><? echo $arResult["ELEMENTS_COUNT"]; ?></span>
                    </div>
                    <? foreach ($arItem["VALUES"] as $val => $ar) { ?>
                        <div class="catalog-small-links__item <? echo $ar["CHECKED"] ? ' catalog-small-selected' : '' ?>">
                            <label <? echo $ar["DISABLED"] ? 'style="display:none"' : '' ?>
                                    data-role="label_<?= $ar["CONTROL_ID"] ?>" for="<? echo $ar["CONTROL_ID"] ?>">
                                <?= $ar["VALUE"]; ?>
                            </label>
                            <span><? echo intval($ar["ELEMENT_COUNT"]); ?></span>
                            <input
                                    style="display: none"
                                    type="checkbox"
