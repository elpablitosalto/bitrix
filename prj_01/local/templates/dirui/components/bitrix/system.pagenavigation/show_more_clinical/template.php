...
<? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) { ?>
    <div id="<?= $idNav ?>">
        <a class="link-button_rose js_more_items" data-id-nav="<?= $idNav ?>" data-nav-num="<?= $arResult["NavNum"] ?>" data-page-nomer="<?= $arResult["NavPageNomer"] ?>" data-max-page="<?= $arResult["NavPageCount"] ?>" href="#">Смотреть больше</a>
    </div>
<? } ?>