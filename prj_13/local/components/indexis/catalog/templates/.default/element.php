...
$APPLICATION->SetPageProperty("BODY_CLASS", 'page-card-product');
$APPLICATION->SetPageProperty("PAGE_SECTION_CLASS", 'card-title');
$APPLICATION->SetPageProperty("MICROMARKING_PARAMS_PAGE_SECTION", 'itemscope itemtype="https://schema.org/Product"');
// <-- Параметры для шаблона
...
<section class="<? $APPLICATION->ShowProperty("PAGE_SECTION_CLASS"); ?>" <? $APPLICATION->ShowProperty("MICROMARKING_PARAMS_PAGE_SECTION"); ?>>
	...
	<div class="card-title__title">
		<div class="card-title__titles">
			<h1 itemprop="name"><? $APPLICATION->ShowTitle(false); ?></h1>
			<? $APPLICATION->ShowViewContent("AFTER_H1_BLOCK"); ?>
		</div>
		<?
...
<section class="card-main">
	<?
	$APPLICATION->ShowViewContent('CatalogElementTabs');
	?>
	<div class="card-main__reviews card-title__anchor" id="reviews" itemprop="review" itemtype="http://schema.org/Review" itemscope="">
		<?
		$GLOBALS['arFilterReviewsCard'] = array('PROPERTY_HIDDEN_PRODUCT' => $elementId);
		$GLOBALS['arrPagerReviewsCard'] = array('PAGER_ID' => 'nav_' . md5(mt_rand()));
		?>
		<? $APPLICATION->IncludeComponent(
			"bitrix:news.list",
			"reviews",
			array(
				...
				"SORT_BY2" => "SORT",
				"SORT_ORDER2" => "ASC",
				"FILTER_NAME" => "arFilterReviewsCard",
				"FIELD_CODE" => array("ID", 'NAME', 'DATE_CREATE'),
				"PROPERTY_CODE" => array("HIDDEN_PRODUCT", 'IMAGES', 'RATING', 'NAME', 'HEADER', 'TEXT'),
				"CHECK_DATES" => "Y",
				"DETAIL_URL" => "",
				...
				"MESSAGE_404" => "",
				"PAGER_BASE_LINK" => "",
				"PAGER_PARAMS_NAME" => "arrPagerReviewsCard",
				"AJAX_OPTION_JUMP" => "N",
				"AJAX_OPTION_STYLE" => "N",
	...
	<div class="card-main__questions card-title__anchor" id="questions">
		<?
		$GLOBALS['arFilterReviewsCard'] = array(
			'PROPERTY_HIDDEN_PRODUCT' => $elementId,
			//'!DETAIL_TEXT' => false,
		);
		?>
		<? $APPLICATION->IncludeComponent(
			...
			array(
				...
				"FILTER_NAME" => "arFilterReviewsCard",
				"FIELD_CODE" => array("ID", 'NAME', 'DATE_CREATE'),
				"PROPERTY_CODE" => array("HIDDEN_PRODUCT", 'WHO_ANSWERED', 'NAME', 'HEADER', 'TEXT', 'ANSWER'),
				"CHECK_DATES" => "Y",
				"DETAIL_URL" => "",
				"PREVIEW_TRUNCATE_LEN" => "",
				"ACTIVE_DATE_FORMAT" => "d.m.Y",
...
<?*/?>
<?
$APPLICATION->ShowViewContent('RelatedSimilarViewed');
?>