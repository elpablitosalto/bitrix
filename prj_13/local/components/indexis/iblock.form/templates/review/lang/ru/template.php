...
$MESS['FS_HEADER_ERROR_MINLEN'] = 'Заголовок должен быть более 1 символа';
...
$MESS['FS_CAPTCHA'] = 'Введите символы с картинки';

$MESS['SUCCESS_MESSAGE_REVIEW'] = 'Отзыв успешно добавлен. После модерации он будет опубликован.';
$MESS['SUCCESS_MESSAGE_QUESTION'] = 'Вопрос успешно добавлен. После модерации он будет опубликован.';

$MESS['FS_FORM_AGREEMENT'] = 'Нажимая на кнопку, я соглашаюсь с <a href="#">условиями</a> политики конфиденциальности и обработки персональных данных';
?>