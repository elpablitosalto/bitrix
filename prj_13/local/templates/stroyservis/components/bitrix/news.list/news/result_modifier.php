...
{
    $component->arResult['NavPageCount'] = $arResult["NAV_RESULT"]->NavPageCount;
    $component->arResult['PAGEN'] = $arResult["NAV_RESULT"]->PAGEN;
    $component->SetResultCacheKeys(array('NavPageCount','PAGEN'));
}
