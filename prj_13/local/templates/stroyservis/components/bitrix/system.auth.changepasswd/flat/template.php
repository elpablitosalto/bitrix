...
<?if($arResult["SHOW_FORM"]):?>
	...
	<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" class="popup-authorization__form">
<?if ($arResult["BACKURL"] <> ''): ?>
...
?>
		<div class="form__input">
			<label class="visually-hidden"><?echo GetMessage("system_change_pass_current_pass")?> *</label>
			<div class="bx-authform-input-container">
...
<?endif?>
				<input type="password" name="USER_CURRENT_PASSWORD" maxlength="255" value="<?=$arResult["USER_CURRENT_PASSWORD"]?>" autocomplete="new-password" placeholder="<?echo GetMessage("system_change_pass_current_pass")?> *" />
			</div>
		</div>
<?
	else:
...
<?endif?>
		...
		<div class="form__input">
			<label class="visually-hidden"><?=GetMessage("AUTH_NEW_PASSWORD_REQ")?> *</label>
			<div class="bx-authform-input-container">
<?if($arResult["SECURE_AUTH"]):?>
...
<?endif?>
				<input type="password" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="new-password" class="order__input" placeholder="<?=GetMessage("AUTH_NEW_PASSWORD_REQ")?> *" />
			</div>
		</div>

		<div class="form__input">
			<label class="visually-hidden"><?=GetMessage("AUTH_NEW_PASSWORD_CONFIRM")?> *</label>
<?if($arResult["SECURE_AUTH"]):?>
...
<?endif?>
				<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="new-password" class="order__input" placeholder="<?=GetMessage("AUTH_NEW_PASSWORD_CONFIRM")?> *" />
		</div>
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="button-orange" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>" />
		</div>
