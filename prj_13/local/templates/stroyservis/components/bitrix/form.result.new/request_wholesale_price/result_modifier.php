...
$arResult["FORM_HEADER"] = '<form novalidate="true" autocomplete="off" data-external-params=\'' . json_encode($arExternalFormParams) . '\' name="' . $arResult["WEB_FORM_NAME"] . '" action="' . $APPLICATION->GetCurDir() . '" method="POST" enctype="multipart/form-data">';