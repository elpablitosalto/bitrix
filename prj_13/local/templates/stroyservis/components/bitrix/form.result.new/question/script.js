$(document).ready(function () {
    ...
    $('.faq-form__wrapper .js_phone_class').inputmask("+7-999-999-99-99");

    $('.faq-form form').each(function () {
        $(this).validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        $('.js_faq_form_container').html($(result).find('.js_faq_form_container').html());
                    },
