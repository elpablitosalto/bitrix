...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<section id="basket-root" class="basket" style="opacity: 0;">
		<div class="basket__wrapper">

			<div class="basket__total-order"><strong data-entity="total-product-count-value">0 товаров</strong>  Вес — <span data-entity="total-weight-value">0 кг</span></div>
			<div class="basket__total-wrapper">
				<div class="basket__total-input">
					<input class="visually-hidden" id="basket-choose-all" type="checkbox" name="basket-all">
					<label for="basket-choose-all">Выбрать все</label>
				</div>
				<button class="basket__delete" style="display: none;">Удалить выбранные</button>
			</div>
			...
			<div class="basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?=$displayModeClass?>"
						...
						<div class="basket-items-list-container" id="basket-items-list-container">
							...
							<div class="basket-items-list" id="basket-item-list">
								...
								<ul class="basket__goods" id="basket-item-table"></ul>
							</div>
						</div>
					</div>
		...
		{
			?>
			<div class="basket__total" data-entity="basket-total-block"></div>

			<div class="basket__mobile">
				<div class="basket__mobile-price">
					<div class="basket__mobile-text">Итого: <span class="basket__mobile-total" data-entity="mobile-total-price"></span>
					</div>
					<div class="basket__mobile-text">Кол-во товаров: <span class="basket__mobile-quantity"><span class="basket__mobile-number" data-entity="mobile-total-product-count-value"></span> шт.</span>
					</div>
				</div>
				<div class="basket__mobile-buttons">
					<button class="button-white basket__total-button basket__button-one-click" data-entity="mobile-basket-one-click">Купить в один клик</button>
					<button class="button-orange basket__total-button" data-entity="mobile-basket-checkout-button">Оформить заказ</button>
				</div>
			</div>
			<?
		}
