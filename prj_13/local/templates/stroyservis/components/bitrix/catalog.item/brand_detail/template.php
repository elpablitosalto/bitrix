...
?>
	...
	<?*/?>
	<li class="product__item product-item-container<?= (isset($arResult['SCALABLE']) && $arResult['SCALABLE'] === 'Y' ? ' product-item-scalable-card' : '') ?>" id="<?= $areaId ?>" data-entity="item" itemtype="https://schema.org/Product" itemprop="itemListElement" itemscope="itemscope">
		<?
