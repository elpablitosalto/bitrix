...
<?endif?>
	...
	<form name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" class="popup-authorization__form">
<?if($arResult["BACKURL"] <> ''):?>
...
<?endif?>
		...
		<div class="form__input">
			<label class="visually-hidden"><?echo GetMessage("AUTH_LOGIN_EMAIL")?> *</label>
			<input type="text" name="USER_LOGIN" maxlength="255" value="" class="order__input" placeholder="<?echo GetMessage("AUTH_LOGIN_EMAIL")?> *" />
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="button-orange" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
		</div>
