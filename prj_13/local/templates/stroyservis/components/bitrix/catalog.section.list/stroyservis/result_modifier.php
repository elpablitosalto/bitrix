...
foreach ($arResult['SECTIONS'] as &$arSection) {
	if( $arSection['NAME'] == 'Гидроизоляционные ленты' )
	{
		$arSection['NAME'] = 'Гидроизоля-<br />ционные ленты';
	}
	if( $arSection['NAME'] == 'Гидроизоляционная мембрана' )
	{
		$arSection['NAME'] = 'Гидроизоля-<br />ционная мембрана';
	}
}
// <-- Переносы в заголовках
...
//vardump($arResult);
$this->__component->SetResultCacheKeys(array("SECTIONS_COUNT"));
// <-- Количество подразделов
