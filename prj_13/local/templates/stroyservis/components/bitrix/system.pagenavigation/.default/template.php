    ...
    <div class="pagination">
            ...
            if (TRUE) {
                ...
                <ul class="pagination__list">
                    ...
                    <? if ($arResult["nStartPage"] > 1) {
                        ...
                        <? if ($arResult["nStartPage"] > 2) { ?>
                            <li><a target="_self" class="pagination__item" onclick="return false;">...</a></li>
                            <?/*?>
                            <span class="blog-page-dots">...</span>
                            <span class="blog-vert-separator">|</span>
                            <?*/ ?>
                ...
                do {
                    ...
                    */
                    ...
                    if ($arResult["nStartPage"] == $arResult["NavPageNomer"]) :
                        ?>
                        <li><a target="_self" class="pagination__item pagination__item_select" onclick="return false;"><?= $number ?></a></li>
                        <?/*?>
        ...
        /*
            if ($arResult["bShowAll"]) {
                ...
                ?>
                    <a target="_self" class="blog-page-pagen" href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>SHOWALL_<?= $arResult["NavNum"] ?>=0"><?= GetMessage("nav_paged") ?></a>
                <? } else { ?>
                    <a target="_self" class="blog-page-all" href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>SHOWALL_<?= $arResult["NavNum"] ?>=1"><?= GetMessage("nav_all") ?></a>
            <?
                }
            }
            */
