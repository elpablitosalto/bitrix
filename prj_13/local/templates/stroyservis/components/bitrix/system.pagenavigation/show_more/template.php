...
<? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) { ?>
    <div id="<?= $idNav ?>">
        <button class="card-main__reviews-show js_more_items<?/*?>_<?= $idNav ?><?*/?>" data-id-nav="<?= $idNav ?>" data-nav-num="<?= $arResult["NavNum"] ?>" data-page-nomer="<?= $arResult["NavPageNomer"] ?>" data-max-page="<?= $arResult["NavPageCount"] ?>">Показать еще</button>
    </div>
<? } ?>