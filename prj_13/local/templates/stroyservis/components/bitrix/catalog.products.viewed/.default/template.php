...
$generalParams = array(
	...
	'PROPERTY_CODE' => array_merge($arParams['PROPERTY_CODE'], array('PRICE_HIDE')),
);
...
<div class="viewed">
	<div class="title-section">
		...
		<div class="viewed__navigation">
			<div class="button-arrow button-arrow_left viewed__prev"></div>
			<div class="button-arrow button-arrow_right viewed__next"></div>
		</div>
	</div>
	<div class="viewed__slider">
		<ul class="viewed__list">
			<?
