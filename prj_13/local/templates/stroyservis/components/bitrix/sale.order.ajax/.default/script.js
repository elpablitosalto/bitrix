BX.saleOrderAjax = {
	...
	init: function(options)
	{
		...
		$('body').on('click', '.order__section-title', function() {
			var $blockToggle = $(this).next('.order__block-toggle');
			$blockToggle.prop('checked', !$blockToggle.is(':checked'));
		});

		$('body').on('change', '#order__agreement', function() {
			$('#ORDER_CONFIRM_BUTTON').prop('disabled', !$(this).is(':checked')).prev('.order__error').css({
