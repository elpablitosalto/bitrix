...
<div class="search__section">
	<p class="search__title">Разделы</p>
...
<div class="search__result catalog-section bx-<?= $arParams['TEMPLATE_THEME'] ?>" data-entity="<?= $containerName ?>">
	<?
	//vardump($_COOKIE);
	...
	?>
		<p class="search__title">Товары</p>
