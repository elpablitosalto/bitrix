	...
	?>
		<div class="analog">
			<div class="title-section">
				...
				<div class="analog__navigation">
					<div class="button-arrow button-arrow_left analog__prev"></div>
					<div class="button-arrow button-arrow_right analog__next"></div>
				</div>
			</div>
			<div class="analog__slider">
