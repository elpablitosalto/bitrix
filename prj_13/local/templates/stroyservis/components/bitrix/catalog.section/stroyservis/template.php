...
?>
<div id="js_catalog_wrapper" class="catalog_wrapper">
	<div class="catalog-section bx-<?= $arParams['TEMPLATE_THEME'] ?>">
		<?
		//vardump($_COOKIE);
		//vardump(array( 'ELEMENT_SORT_FIELD' => $arParams['ELEMENT_SORT_FIELD'], 'ELEMENT_SORT_ORDER' => $arParams['ELEMENT_SORT_ORDER'] ));
		?>
		<?
		if (!empty($arResult['ITEMS'])) {
			$generalParams = [
				...
				//'~ADD_URL_TEMPLATE' => $arParams['BASKET_AJAX_URL'],
				//'~BUY_URL_TEMPLATE' => $arParams['BASKET_AJAX_URL'],
			...
			foreach ($arResult['ITEMS'] as $item) {
				...
				$itemParameters[$item['ID']] = [
					...
					'RAITING' => $arResult['arReitings'][$item['ID']]['AVERAGE_RAITING'],
					'RAITING_COUNT' => $arResult['arReitings'][$item['ID']]['RAITING_COUNT'],
				];
				//$itemParameters[$item['ID']]['RAITING'] = $arResult['arReitings'][$arItem['ID']]['AVERAGE_RAITING'];
				//$itemParameters[$item['ID']]['RAITING_COUNT'] = $arResult['arReitings'][$arItem['ID']]['RAITING_COUNT'];
			}
		?>
			<div class="page-main__products">
				<div class="products-grouts">
					<ul class="products-grouts__list" itemtype="https://schema.org/ItemList" itemscope data-entity="<?= $containerName ?>">
						<!-- items-container -->
						<? foreach ($arResult['ITEMS'] as $key => $arItem) { ?>
							<?
							//echo 'RAITING = '.$arResult['arReitings'][$arItem['ID']]['AVERAGE_RAITING'].'<br />';
							//echo 'RAITING_COUNT = '.$arResult['arReitings'][$arItem['ID']]['RAITING_COUNT'].'<br />';
							//vardump($arItem);
					...
					{
						?>
						<div class="btn btn-default btn-lazy"
					...
					{
						?>
						<div class="products-grouts__pagination" data-pagination-num="<?=$navParams['NavNum']?>">
							<!-- pagination-container -->
							<?=$arResult['NAV_STRING']?>
							<!-- pagination-container -->
						</div>
					...
					<? if ($arParams['HIDE_FAST_FILTER'] != 'Y') : ?>
						<?/*?>
						<div class="products-grouts__goods">
...
<section class="description-grouts">
