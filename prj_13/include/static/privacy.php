    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="descr">
                ...
                данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">Михайловым Иваном
                    Сергеевичем</span> (далее&nbsp;— Оператор).
            </div>
            <div class="ol">
                <div class="li">
                ...
                <div class="li">
                    ...
                    которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">httpsː//thismywebsite·com</span>.
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col">
            ...
            <div class="ol">
                ...
                <div class="li">
                    ...
                    их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">httpsː//thismywebsite·com</span>.
                </div>
                <div class="li">
                ...
                <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                    ...
                    Пользователю веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">httpsː//thismywebsite·com</span>.
                </div>
                <div class="li">
                ...
                <div class="li">
                    2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">httpsː//thismywebsite·com</span>.
                </div>
                <div class="li">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="legal-field">
                                    <ul>
                                        <li><span class="mark link">Федеральный закон «Об&nbsp;информации, информационных технологиях и&nbsp;о&nbsp;защите информации» от&nbsp;27.07.2006&nbsp;N 149-ФЗ</span></li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="col">
            ...
            <div class="ol">
                ...
                <div class="li">
                    ...
                    Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">privacy@thismywebsite·com</span>
                ...
                <div class="li">
                    ...
                    посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">privacy@thismywebsite·com</span>
        ...
        <div class="col">
            ...
            <div class="ol">
                <div class="li">
                    ...
                    к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">privacy@thismywebsite·com</span>.
                </div>
                <div class="li">
                ...
                <div class="li">
                    ...
                    в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">httpsː//thismywebsite·com/privacy/</span>.
                </div>
            </div>
        </div>
    </div>
