...
<?
$GLOBALS['arHomePromoFilter'] = [
    '!PROPERTY_IS_MAPEI' => false
];
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "FILTER_NAME" => "arHomePromoFilter",	// Фильтр
        "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
        "IBLOCK_ID" => Indexis::getIblockId('promos', 'catalog'),	// Код информационного блока
