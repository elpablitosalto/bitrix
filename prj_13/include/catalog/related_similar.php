<?
//vardump($arParams);
$filterCode = $arParams['filterCode'];
if (!empty($arParams[$filterCode]) && strlen( $arParams['template'] ) > 0) {
    $GLOBALS[$filterCode] = $arParams[$filterCode];
    //vardump($arResult[$filterCode]);
?>
