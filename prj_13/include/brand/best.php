...
<?
$GLOBALS['arBestBrandFilter'] = [
    '!PROPERTY_SHOW_ON_HOME' => false
];
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "FILTER_NAME" => "arBestBrandFilter",	// Фильтр
        "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
        "IBLOCK_ID" => Indexis::getIblockId('brands', 'catalog'),	// Код информационного блока
